...
<body>
    <section class="header">
        ...
        <div class="titlu">
            <h1>Capitolul 10 - partea 6 - Infracțiuni - diverse</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c10_p7.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>Codul penal - Articolul 339</h2>
            <p>
                &Icirc;mpiedicarea sau &icirc;ngreunarea circulaţiei pe drumurile publice
            </p>
            <p>
                <strong>(1)</strong>
                Instalarea de mijloace de semnalizare rutieră sau modificarea poziţiilor acestora, fără autorizaţie 
                eliberată de autorităţile competente, de natură să inducă &icirc;n eroare participanţii la trafic ori 
                să &icirc;ngreuneze circulaţia pe drumul public se pedepseşte cu &icirc;nchisoare de la 3 luni la 2 
                ani sau cu amendă.
            </p>
            <p>
                <strong>(2) </strong>
                Participarea &icirc;n calitate de conducător de vehicul la &icirc;ntreceri neautorizate pe drumurile publice 
                se pedepseşte cu &icirc;nchisoare de la 3 luni la un an sau cu amendă.
            </p>
            <p>
                <strong>(3)</strong>
                Cu aceeaşi pedeapsă se sancţionează aşezarea de obstacole care &icirc;ngreunează sau &icirc;mpiedică circulaţia 
                pe drumul public, dacă se pune &icirc;n pericol siguranţa circulaţiei ori se aduce atingere dreptului la libera 
                circulaţie a celorlalţi participanţi la trafic.
            </p>
            <p>
                <strong>(4) </strong>
                Lăsarea fără supraveghere pe partea carosabilă a drumului public a unui vehicul care transportă produse sau 
                substanţe periculoase se pedepseşte cu &icirc;nchisoare de la unu la 3 ani sau cu amendă.
            </p>
            <h2>Codul penal - Articolul 340</h2>
            <p>
                Nerespectarea atribuţiilor privind verificarea tehnică ori efectuarea reparaţiilor
            </p>
            <p>
                <strong>(1) </strong>
                &Icirc;ndeplinirea defectuoasă sau ne&icirc;ndeplinirea atribuţiilor de verificare tehnică ori inspecţie 
                tehnică periodică a autovehiculelor, remorcilor sau tramvaielor ori a celor referitoare la efectuarea unor 
                reparaţii sau intervenţii tehnice de către persoanele care au asemenea atribuţii, dacă din cauza stării tehnice 
                a vehiculului s-a pus &icirc;n pericol siguranţa circulaţiei pe drumurile publice, se pedepseşte cu &icirc;nchisoare 
                de la 3 luni la 2 ani sau cu amendă.
            </p>
            <p>
                <strong>(2) </strong>
                Dacă, urmare a faptei prevăzute &icirc;n alin. (1), s-a produs un accident de circulaţie care a avut ca urmare 
                vătămarea integrităţii corporale sau a sănătăţii uneia sau mai multor persoane, pedeapsa este &icirc;nchisoarea 
                de la unu la 5 ani, iar dacă s-a produs moartea uneia sau mai multor persoane, pedeapsa este &icirc;nchisoarea 
                de la 3 la 10 ani.
            </p>
            <p>
                <strong>(3)</strong>
                Dacă faptele prevăzute &icirc;n alin. (1) şi alin. (2) au fost săv &acirc;rşite din culpă, limitele speciale 
                ale pedepsei se reduc cu o treime.
            </p>
            <p>
                <strong>(4)</strong>
                Repararea autovehiculelor, remorcilor, tramvaielor sau mopedelor av &acirc;nd urme de accident, fără a fi 
                &icirc;ndeplinite condiţiile prevăzute de lege, se pedepseşte cu &icirc;nchisoare de la 3 luni la 2 ani sau 
                cu amendă.
            </p>
            <h2>Codul penal - Articolul 341</h2>
            <p>Efectuarea de lucrări neautorizate &icirc;n zona drumului public</p>
            <p>
                <strong>(1)</strong>
                Efectuarea unor lucrări de construire, modificare, modernizare sau reabilitare a drumului public ori de 
                amenajare a accesului rutier la drumul public, fără autorizaţie de construcţie eliberată &icirc;n condiţiile 
                legii ori cu &icirc;ncălcarea condiţiilor stabilite &icirc;n autorizaţie, se pedepseşte cu &icirc;nchisoare 
                de la 6 luni la 3 ani sau cu amendă.
            </p>
            <p>
                <strong>(2)</strong>
                Amplasarea unor construcţii, panouri sau reclame publicitare &icirc;n zona drumului, fără autorizaţie de 
                construcţie eliberată &icirc;n condiţiile legii ori cu &icirc;ncălcarea condiţiilor stabilite &icirc;n 
                autorizaţie, dacă prin aceasta se creează un pericol pentru siguranţa circulaţiei, se pedepseşte cu 
                &icirc;nchisoare de la 3 luni la un an sau cu amendă.
            </p>
            <p>
                <strong>(3)</strong>
                Persoana autorizată de administratorul căii ferate care nu ia măsurile corespunzătoare pentru semnalizarea 
                trecerilor la nivel cu calea ferată se pedepseşte cu &icirc;nchisoare de la 3 luni la 2 ani sau cu amendă.
            </p>
            <p>
                <strong>(4)</strong>
                Cu pedeapsa prevăzută &icirc;n alin. (3) se sancţionează şi persoana autorizată de către administratorul 
