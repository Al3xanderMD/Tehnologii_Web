...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 4 - partea 3 - Autostrada</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/OPeCstAWrAc">
            </iframe>                                   
        </div>
        <div>
            <a href="c4_p4.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>5.</strong>
                autostrada - drumul naţional de mare capacitate şi viteză, semnalizat special, rezervat 
                exclusiv circulaţiei autovehiculelor, cu sau fără remorci, care nu serveşte proprietăţii
                 riverane, prevăzut cu două căi unidirecţionale, separate printr-o zonă mediană sau, 
                 &icirc;n mod excepţional, prin alte modalităţi, cu excepţia unor locuri speciale sau 
                 cu caracter temporar, av&acirc;nd cel puţin două benzi de circulaţie pe sens şi banda 
                 de urgenţă, intersecţii denivelate şi accese limitate, intrarea şi ieşirea fiind permise 
            ...
            <p>
                <em>
                    <u>
                        <strong>
                            (Articolul 74 a fost modificat și actualizat pe www.scoalarutiera.ro 
                            la 16-05-2022)
                        </strong>
                    </u>
                </em>
            ...
            <p>
                <strong>(1)</strong>
                Pe autostrăzi sau pe drumurile expres este interzisă circulația pietonilor, a 
                autovehiculelor cu gabarite sau mase depășite, fără autorizație specială de transport 
                eliberată de administratorul drumului public, conform reglementărilor &icirc;n vigoare, 
                a vehiculelor cu tracțiune animală, a animalelor, a vehiculelor trase sau &icirc;mpinse 
                cu m&acirc;na, a bicicletelor, trotinetelor electrice și mopedelor, a tractoarelor 
                agricole sau forestiere și a mașinilor autopropulsate pentru lucrări agricole, precum 
                și a vehiculelor care, prin construcție sau din alte cauze, nu pot depăși viteza de 
                50 km/h.<br/>
                <strong>(2)</strong>
                De asemenea, pe autostrăzi sau pe drumurile expres sunt interzise &icirc;nvățarea 
                conducerii unui vehicul, &icirc;ncercările prototipurilor de șasiuri și de autovehicule, 
                manifestațiile, defilările, caravanele publicitare, antrenamentele și competițiile sportive 
                de orice fel, precum și cortegiile.<br/>
                <strong>(3)</strong>
                Se interzice circulația, oprirea sau staționarea autovehiculelor pe banda de urgență sau 
                acostament, cu excepția cazurilor justificate, precum și a autovehiculelor cu regim de 
                circulație prioritar.<br/>
                <strong>(4)</strong>
                Circulația autovehiculelor destinate transportului public de persoane sau de mărfuri se 
                efectuează, de regulă, numai pe banda marginală din partea dreaptă a autostrăzii sau a 
                drumului expres, &icirc;n sensul de mers.
            </p>
            <h2>Regulament - Articolul 169</h2>
            <p>
                <strong>(1)</strong>
                Conducătorii de autovehicule care intra pe autostrăzi folosind banda de intrare 
                (de accelerare) trebuie să cedeze trecerea autovehiculelor care circulă pe prima 
                bandă a autostrăzilor şi să nu st&acirc;njenească &icirc;n niciun fel circulaţia 
                acestora.
            </p>
            <p>
                <strong>(2)</strong>
                Conducătorii de autovehicule care urmează să părăsească autostrada sunt obligaţi să 
                semnalizeze din timp şi să se angajeze pe banda de ieşire (de decelerare).
            </p>
            <h2>Regulament - Articolul 170</h2>
            <p>
                Circulaţia autovehiculelor destinate transportului public de persoane sau de mărfuri 
                se desfăşoară pe banda din partea dreaptă a autostrăzii, cu excepţia cazului &icirc;n c
                are se efectuează depăşirea sau semnalizarea rutieră existentă instituie o altă 
