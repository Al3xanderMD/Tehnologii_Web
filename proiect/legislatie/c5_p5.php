...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 5 - partea 5 - alte cazuri de acordare de prioritate</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c6_p1.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
    </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>OUG - Articolul 58</h2>
            <p>
                &Icirc;n cazul vehiculelor care pătrund &icirc;ntr-o intersecţie dintre un drum &icirc;nchis circulaţiei 
                publice şi un drum public, au prioritate acele vehicule care circulă pe drumul public.<br/>
            </p>
            <h2>Regulament - Articolul 127</h2>
            <p>
                <strong>(1)</strong>
                Pe drumurile publice &icirc;nguste şi/sau cu declivitate, unde trecerea vehiculelor care circulă din sensuri 
                opuse, unele pe l&acirc;ngă altele, este imposibilă sau periculoasă, se procedează după cum urmează:
            </p>
            <p>
                <strong>a)</strong>
                la &icirc;nt&acirc;lnirea unui ansamblu de vehicule cu un vehicul conducătorul acestuia din urma trebuie 
                să manevreze cu spatele;<br/>
                <strong>b)</strong>
                la &icirc;nt&acirc;lnirea unui vehicul greu cu un vehicul uşor, conducătorul acestuia din urma trebuie 
                să manevreze cu spatele;<br/>
                <strong>c)</strong>
                la &icirc;nt&acirc;lnirea unui vehicul care efectuează transport public de persoane cu un vehicul de 
                transport mărfuri conducătorul acestuia din urma trebuie să manevreze cu spatele.
            </p>
            <p>
                <strong>(2)</strong>
                &Icirc;n cazul vehiculelor de aceeaşi categorie, obligaţia de a efectua o manevră de mers &icirc;napoi 
                revine conducătorului care urca, cu excepţia cazului c&acirc;nd este mai uşor şi există condiţii pentru 
                conducătorul care coboară să execute această manevră, mai ales atunci c&acirc;nd se află aproape de un refugiu.
            </p>
            <h2>Regulament - Articolul 134</h2>
            <p>
                La ieşirea din zonele rezidenţiale sau pietonale, conducătorii de vehicule sunt obligaţi să acorde prioritate 
                de trecere tuturor vehiculelor cu care se intersectează.
            </p>
            <h2>Regulament - Articolul 135</h2>
            <p>
                Conducătorul de vehicul este obligat să acorde prioritate de trecere şi &icirc;n următoarele situaţii:
            </p>
            <p>
                <strong>a)</strong>
                la intersecţia nedirijată atunci c&acirc;nd pătrunde pe un drum naţional venind de pe un drum judeţean, 
                comunal sau local;<br/>
                <strong>b)</strong>
                la intersecţia nedirijată atunci c&acirc;nd pătrunde pe un drum judeţean venind de pe un drum comunal 
                sau local;<br/>
                <strong>c)</strong>
                la intersecţia nedirijată atunci c&acirc;nd pătrunde pe un drum comunal venind de pe un drum local;<br/>
                <strong>d)</strong>
                c&acirc;nd urmează să pătrundă &icirc;ntr-o intersecţie cu circulaţie &icirc;n sens giratoriu faţă de 
                cel care circulă &icirc;n interiorul acesteia;<br/>
                <strong>e)</strong>
                c&acirc;nd circulă &icirc;n panta faţă de cel care urca, dacă pe sensul de mers al celui care urca se 
                află un obstacol imobil. &Icirc;n această situaţie manevra nu este considerată depăşire &icirc;n sensul 
                prevederilor art. 120 lit. j);<br/>
                <strong>f)</strong>
                c&acirc;nd se pune &icirc;n mişcare sau la pătrunderea pe drumul public venind de pe o proprietate 
                alăturată acestuia faţă de vehiculul care circulă pe drumul public, indiferent de direcţia de deplasare;<br/>
                <strong>g)</strong>
                c&acirc;nd efectuează un viraj spre st&acirc;nga sau spre dreapta și se intersectează cu un conducător 
                de bicicletă sau trotinetă electrică care circulă pe o pistă pentru biciclete, semnalizată ca atare;
                <u>
                    <em>
                        <strong>
                            (Litera g) din Articolul 135 a fost modificată și actualizată pe www.scoalarutiera.ro 
                            la 06-10-2021)
                        </strong>
                    </em>
                </u>
                <br/>
                <strong>h)</strong>
                pietonului care traversează drumul public, prin loc special amenajat, marcat şi semnalizat corespunzător 
                ori la culoarea verde a semaforului destinat lui, atunci c&acirc;nd acesta se află pe sensul de mers al 
                vehiculului.
            </p>
