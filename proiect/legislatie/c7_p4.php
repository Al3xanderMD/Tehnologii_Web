...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 7 - partea 4 - trecerea pentru pietoni</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c7_p5.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                ...
                coltul străzii, numai după ce s-au asigurat că o pot face fără pericol pentru ei şi pentru ceilalţi participanţi 
                la trafic.
            </p>
            <p>
                <strong>(4)</strong>
            ...
            <p>Conducătorul de vehicul este obligat să circule cu o viteza care să nu depăşească 30 km/h &icirc;n localităţi 
                sau 50 km/h &icirc;n afara localităţilor, &icirc;n următoarele situaţii:</p>
            <p>
                <strong>h)</strong>
                la trecerile pentru pietoni nesemaforizate, semnalizate prin indicatoare şi marcaje, c&acirc;nd drumul public 
                are cel mult o bandă pe sens, iar pietonii aflaţi pe trotuar, &icirc;n imediată apropiere a părţii carosabile, 
                intenţionează să se angajeze &icirc;n traversare;
            </p>
