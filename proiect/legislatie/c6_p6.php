...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 6 - partea 6 - manevre - mersul înapoi</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/TkDwXMNUngk">
            </iframe>                                   
        </div>
        <div>
            <a href="c7_p1.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>(1)</strong>
                Conducătorul de vehicul care executa o manevra de schimbare a direcţiei de mers, de 
                ieşire dintr-un r&acirc;nd de vehicule staţionate sau de intrare &icirc;ntr-un asemenea r&acirc;nd, de 
                trecere pe o altă bandă de circulaţie sau de virare spre dreapta ori spre st&acirc;nga sau care urmează 
                să efectueze o &icirc;ntoarcere ori să meargă cu spatele este obligat să semnalizeze din timp şi să se 
                asigure că o poate face fără să perturbe circulaţia sau să pună &icirc;n pericol siguranţa celorlalţi 
            ...
            <h2>Regulament - Articolul 128</h2>
            <p>
                <strong>(1)</strong>
                Se interzice mersul &icirc;napoi cu vehiculul:
            </p>
            <p>
                <strong>a)</strong>
                &icirc;n cazurile prevăzute la art. 126, cu excepţia lit. d);
            </p>
            <p>
                <strong>b)</strong>
                pe o distanţă mai mare de 50 m;<br/>
                <strong>c)</strong>
                la ieşirea de pe proprietăţi alăturate drumurilor publice.
            </p>
            <p>
                <strong>(2)</strong>
                &Icirc;n locurile &icirc;n care mersul &icirc;napoi este permis, dar vizibilitatea &icirc;n spate este 
                &icirc;mpiedicată, vehiculul poate fi manevrat &icirc;napoi numai atunci c &acirc;nd conducătorul acestuia 
                este dirijat de cel puţin o persoană aflată &icirc;n afara vehiculului.
            </p>
            <p>
                <strong>(3)</strong>
                Persoana care dirijează manevrarea cu spatele a unui vehicul este obligată să se asigure că manevra se 
                efectuează fără a pune &icirc;n pericol siguranţa participanţilor la trafic.
            </p>
            <p>
                <strong>(4)</strong>
                Mersul &icirc;napoi cu autovehiculul trebuie semnalizat cu lumina sau luminile speciale din dotare. 
                Se recomanda dotarea autovehiculelor şi cu dispozitive sonore pentru semnalizarea acestei manevre.
            </p>
