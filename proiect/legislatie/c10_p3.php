...
<body>
    <section class="header">
        ...
        <div class="titlu">
            <h1>Capitolul 10 - partea 3 - Infracțiuni - Conducerea unui vehicul fără permis deconducere</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c10_p4.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>Codul penal - Articolul 335</h2>
            <p>Conducerea unui vehicul fără permis de conducere</p>
            <p>
                <strong>(1)</strong>
                Conducerea pe drumurile publice a unui autovehicul ori a unui tramvai de către o persoană care nu posedă 
                permis de conducere se pedepseşte cu &icirc;nchisoarea de la unu la 5 ani.
            </p>
            <p>
                <strong>(2)</strong>
                ...
                sau subcategoriei din care face parte vehiculul respectiv ori al cărei permis i-a fost retras sau anulat 
                ori căreia exercitarea dreptului de a conduce i-a fost suspendată sau care nu are dreptul de a conduce 
                autovehicule &icirc;n Rom &acirc;nia se pedepseşte cu &icirc;nchisoare de la 6 luni la 3 ani sau cu amendă.
            </p>
            <p>
                <strong>(3)</strong>
                Cu aceeaşi pedeapsă se sancţionează şi persoana care &icirc;ncredinţează un vehicul pentru care legea 
                prevede obligativitatea deţinerii permisului de conducere pentru conducerea pe drumurile publice unei 
                persoane despre care ştie că se află &icirc;n una dintre situaţiile prevăzute &icirc;n alin. (1) sau 
