...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 5 - partea 3 - Prioritatea de trecere - acordata prin lege</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/ZOOPLooTzTg">
            </iframe>                                   
        </div>
        <div>
            <a href="c5_p4.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>(2)</strong>
                &Icirc;n intersecţii, conducătorii vehiculelor care virează spre st&acirc;nga sunt obligaţi să acorde 
                prioritate de trecere vehiculelor cu care se intersectează şi care circulă din partea dreapta.
            </p>
            <p>
                <strong>(3)</strong>
                &Icirc;n intersecţiile cu circulaţie dirijată prin indicatoare de prioritate, regula priorităţii de dreapta 
                se respecta numai &icirc;n cazul &icirc;n care două vehicule urmează să se &icirc;nt&acirc;lnească, fiecare 
                intr&acirc;nd &icirc;n intersecţie de pe un drum semnalizat cu un indicator av&acirc;nd aceeaşi semnificaţie 
                de prioritate sau de pierdere a priorităţii.
            </p>
            <h2>OUG - Articolul 61</h2>
            <p>
                <strong>(1)</strong>
                Au regim de circulaţie prioritară numai autovehiculele prevăzute la art. 32 alin. (2) lit. a) şi b), 
                atunci c&acirc;nd se deplasează &icirc;n acţiuni de intervenţie sau &icirc;n misiuni care au caracter 
                de urgenţă. Pentru a avea prioritate de trecere, aceste autovehicule trebuie să aibă &icirc;n funcţiune 
                semnalele luminoase şi sonore.
            </p>
            <p></p>
            <h2>Regulament - Articolul 129</h2>
            <p>
                <strong>(2)</strong>
                C&acirc;nd două vehicule urmează să se &icirc;nt&acirc;lnească &icirc;ntr-o intersecţie dirijată 
                prin indicatoare, venind de pe două drumuri publice unde sunt instalate indicatoare cu aceeaşi semnificaţie, 
                vehiculul care vine din dreapta are prioritate.
            </p>
            <h2>Regulament - Articolul 135</h2>
            <p>Conducătorul de vehicul este obligat să acorde prioritate de trecere şi &icirc;n următoarele situaţii:</p>
            <p>
                <strong>e)</strong>
