...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 7 - partea 1 - locuri și situații speciale - trecerea la nivel cu calea ferată</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/VMrWLJiyP2E">
            </iframe>                                   
        </div>
        <div>
            <a href="c7_p2.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box">
            <h1>Articole</h1>
            ...
            <p>
                ...
                de cale ferată curentă sau industrială, după caz.<br/>
                <strong>(3)</strong>
                La trecerea la nivel cu o cale ferată industrială, semnalizată corespunzător, conducătorii de vehicule sunt 
                obligaţi să se conformeze semnificaţiei semnalelor agentului de cale ferată.
            </p>
            <p></p>
            <h2>Regulament - Articolul 68</h2>
            <p>
                Apropierea de o trecere la nivel cu calea ferată se semnalizează cu indicatoare de avertizare corespunzătoare 
                şi/sau cu panouri suplimentare pentru trecerea la nivel cu calea ferată.
            </p>
            <h2>Regulament - Articolul 73</h2>
            <p>
                <strong>(1) </strong>
                La trecerea la nivel cu o cale ferată industrială se instalează indicatorul Alte pericole , 
                &icirc;nsoţit de un panou adiţional ce conţine imaginea unei locomotive.
            </p>
            <p>
                <strong>(2)</strong>
                Atunci c&acirc;nd pe calea ferată industrială se deplasează un vehicul feroviar, circulaţia trebuie dirijată 
                de un agent de cale ferată.
            </p>
            <h2>Regulament - Articolul 136</h2>
            <p>
                <strong>(1)</strong>
                La trecerea la nivel cu calea ferată curentă, conducătorul de vehicul este obligat să circule cu viteza redusă 
                şi să se asigure ca din partea st&acirc;nga sau din partea dreaptă nu se apropie un vehicul feroviar.
            </p>
            <p>
                <strong>(2)</strong>
                La traversarea caii ferate, pietonii sunt obligaţi să se asigure că din st&acirc;nga sau din dreapta nu se 
            ...
            <h2>Regulament - Articolul 140</h2>
            <p>
                <strong>(1)</strong>
                La intersectarea unui drum public cu o cale ferată industrială, accesul vehiculelor feroviare se face numai 
                după semnalizarea corespunzătoare şi din timp de către cel puţin un agent de cale ferată.
            </p>
            <p>
                <strong>(2)</strong>
                &Icirc;n cazul prevăzut la alin. (1), conducătorii de vehicule sunt obligaţi să se conformeze semnificaţiei 
                semnalelor agenţilor de cale ferată.
            </p>
