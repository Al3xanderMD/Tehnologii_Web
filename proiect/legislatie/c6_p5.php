...
<body>
    <section class="header">
        ...
        <div class="titlu">
            <h1>Capitolul 6 - partea 5 - manevre - întoarcerea</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/efW3oNsJSP0">
            </iframe>                                   
        </div>
        <div>
            <a href="c6_p6.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                ...
                cu spatele este obligat să semnalizeze din timp şi să se asigure că o poate face fără să perturbe circulaţia 
                sau să pună &icirc;n pericol siguranţa celorlalţi participanţi la trafic.
            </p>
            <p>
                <strong>(2)</strong>
            ...
            <p>
                ...
                sau a celor care urmează să efectueze &icirc;ntoarcere, depășire ori oprire se semnalizează prin punerea &icirc;n 
                funcțiune a luminilor indicatoare de direcție cu cel puțin 50 m &icirc;n localități și 100 m &icirc;n afara 
                localităților &icirc;nainte de &icirc;nceperea efectuării manevrelor.
                <u>
                    <em>
                        <strong>
            ...
            <p>
                Pentru a putea &icirc;ntoarce vehiculul de pe un sens de mers pe celălalt prin manevrare &icirc;nainte şi 
                &icirc;napoi sau prin viraj, conducătorul acestuia este obligat să semnalizeze şi să se asigure că din faţă, 
                din spate sau din lateral nu circulă &icirc;n acel moment niciun vehicul.
            </p>
            <h2>Regulament - Articolul 126</h2>
            <p>
                Se interzice &icirc;ntoarcerea vehiculului:
            </p>
            <p>
                <strong>a)</strong>
                &icirc;n locurile &icirc;n care este interzisă oprirea voluntară a vehiculelor, cu excepţia cazurilor 
                prevăzute la art. 142 lit. f);
            </p>
            <p>
                <strong>b)</strong>
                &icirc;n intersecţiile &icirc;n care este interzis virajul la st &acirc;nga, precum şi &icirc;n cele &icirc;n 
                care, pentru efectuare, este necesară manevrarea &icirc;nainte şi &icirc;napoi a vehiculului;<br/>
                <strong>c)</strong>
                &icirc;n locurile unde soliditatea drumului nu permite;<br/>
                <strong>d)</strong>
                pe drumurile cu sens unic;<br/>
                <strong>e)</strong>
                pe marcajul pietonal;<br/>
                <strong>f)</strong>
                &icirc;n locurile &icirc;n care este instalat indicatorul &Icirc;ntoarcerea interzisă.
            </p>
