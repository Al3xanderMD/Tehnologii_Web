...
<div class="meniu">
    <nav>
        ...
        <div class="titlu">
            <h1>Capitolul 1 - partea 1: Drumul public</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/L82M5k2wqis">
            </iframe>
        </div>
        <div>
            <a href="c1_p2.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
    </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>  
                <strong>14.</strong>
                drum public - orice cale de comunicaţie terestra, cu excepţia căilor ferate, special amenajată
                pentru traficul pietonal sau rutier, deschisă circulaţiei publice; drumurile care sunt închise
                circulaţiei publice sunt semnalizate la intrare cu inscripţii vizibile;</p>

            <p> 
                <strong>23.</strong>
                parte carosabilă - porţiunea din platforma drumului destinată circulaţiei vehiculelor; un drum poate
                cuprinde mai multe părţi carosabile complet separate una de cealaltă printr-o zonă despărţitoare sau
                prin diferenţa de nivel;</p>
            ...
            <h2>Regulament - Articolul 3</h2>
            <p>
                <strong>(5)</strong>
                La intrarea pe un drum care nu este deschis circulaţiei publice, proprietarul sau administratorul
                acestuia este obligat să instaleze, în loc vizibil, indicator cu semnificaţia "Accesul interzis" şi
                panou cu inscripţia "Drum închis circulaţiei publice".</p>
            <p> </p>
        </div>
        <div class="dropdown">
