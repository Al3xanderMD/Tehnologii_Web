...
<body>
    <section class="header">
        ...
        <div class="titlu">
            <h1>Capitolul 7 - partea 3 - trecerea la nivel cu calea ferată cu bariere</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c7_p4.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>OUG - Articolul 60</h2>
            <p>
                <strong>(1)</strong>
                Participanţii la trafic trebuie să dea dovada de prudenţă sporită la apropierea şi traversarea liniilor 
                de cale ferată curentă sau industrială, după caz.
            </p>
            <p>
                <strong>(2)</strong>
                La trecerea la nivel cu o cale ferată curentă, prevăzută cu bariere sau semibariere, conducătorii de vehicule 
                sunt obligaţi să oprească &icirc;n dreptul indicatorului ce obliga la oprire, dacă acestea sunt &icirc;n curs 
                de cobor&acirc;re ori &icirc;n poziţie orizontala şi/sau semnalele sonore şi luminoase care anunţă apropierea 
                trenului sunt &icirc;n funcţiune.
            </p>
            <p>&nbsp;</p>
            <h2>Regulament - Articolul 69</h2>
            <p>
                <strong>(2)</strong>
                La trecerea la nivel cu calea ferată curentă prevăzută cu instalaţii de semnalizare automată fără bariere, 
                interzicerea circulaţiei rutiere se realizează, optic, prin funcţionarea dispozitivelor cu lumini intermitent-alternative roşii şi stingerea semnalizării de control reprezentate de lumină intermitentă albă şi, acustic, prin emiterea de semnale sonore intermitente.
            </p>
            <h2>Regulament - Articolul 71</h2>
            <p>
                <strong>(1)</strong>
                Semnalizarea de interzicere a circulaţiei rutiere se considera realizata chiar şi numai &icirc;n una din 
                următoarele situaţii:
            </p>
            <p>
                <strong>a)</strong>
                prin aprinderea unei singure unităţi luminoase a dispozitivului cu lumină intermitent-alternativa roşie;<br/>
                <strong>b)</strong>
                prin funcţionarea sistemului sonor;<br/>
                <strong>c)</strong>
                prin poziţia orizontala a unei singure semibariere.
            </p>
            <p>
                <strong>(2)</strong>
                Circulaţia rutieră se considera de asemenea interzisă şi &icirc;n situaţia &icirc;n care barierele sau 
                semibarierele sunt &icirc;n curs de cobor &acirc;re sau de ridicare.
            </p>
            <h2>Regulament - Articolul 136</h2>
            <p>
                <strong>(1)</strong>
                La trecerea la nivel cu calea ferată curentă, conducătorul de vehicul este obligat să circule cu viteza redusă şi să se asigure ca din partea st &acirc;nga sau din partea dreaptă nu se apropie un vehicul feroviar.
            </p>
            <h2>Regulament - Articolul 137</h2>
            <p>
                <strong>(1)</strong>
                Conducătorul de vehicul poate traversa calea ferată curentă prevăzută cu bariere sau semibariere, dacă 
                acestea sunt ridicate şi semnalele luminoase şi sonore nu funcţionează, iar semnalul cu lumină albă 
                intermitentă cu cadenţă lentă este &icirc;n funcţiune.
            </p>
            <p>
                <strong>(2)</strong>
                C&acirc;nd circulaţia la trecerea la nivel cu calea ferată curentă este dirijată de agenţi de cale 
                ferată, conducătorul de vehicul trebuie să respecte semnalele acestora.
            </p>
            <h2>Regulament - Articolul 138</h2>
            <p>
                <strong>(1) </strong>
                Conducătorul de vehicul este obligat să oprească atunci c&acirc;nd:
            </p>
            <p>
                <strong>a)</strong>
                barierele sau semibarierele sunt cobor &acirc;te, &icirc;n curs de cobor &acirc;re sau de ridicare;<br/>
                <strong>b)</strong>
                semnalul cu lumini roşii şi/sau semnalul sonor sunt &icirc;n funcţiune;<br/>
                <strong>c)</strong>
                &icirc;nt &acirc;lneşte indicatorul Trecerea la nivel cu calea ferată simplă, fără bariere , Trecerea la 
                nivel cu calea ferată dublă, fără bariere sau Oprire .
            </p>
            <p>
                <strong>(2) </strong>
                Vehiculele trebuie să oprească, &icirc;n ordinea sosirii, &icirc;n locul &icirc;n care există vizibilitate 
                maxima asupra caii ferate fără a trece de indicatoarele prevăzute la alin. (1) lit. c) sau, după caz, 
                &icirc;naintea marcajului pentru oprire ori &icirc;naintea barierelor sau semibarierelor, c&acirc;nd acestea 
                sunt &icirc;nchise, &icirc;n curs de cobor &acirc;re sau de ridicare.
            </p>
            <h2>Regulament - Articolul 139</h2>
            <p>
                <strong>(1)</strong>
                &Icirc;n cazul imobilizării unui vehicul pe calea ferată, conducătorul acestuia este obligat să scoată imediat 
                pasagerii din vehicul şi să elibereze platforma caii ferate, iar c&acirc;nd nu este posibil, să semnalizeze 
                prezenţa vehiculului cu orice mijloc adecvat.
            </p>
            <p>
                <strong>(2)</strong>
                Participanţii la trafic, care se găsesc &icirc;n apropierea locului unde un vehicul a rămas imobilizat pe 
                calea ferată, sunt obligaţi să acorde sprijin pentru scoaterea acestuia sau, c&acirc;nd nu este posibil, 
                pentru semnalizarea prezentei lui.
            </p>
            <p>
                <strong>(3)</strong>
                Conducătorului de vehicul &icirc;i este interzis să treacă sau să ocolească porţile de gabarit instalate 
                &icirc;naintea cailor ferate electrificate, dacă &icirc;nălţimea sau &icirc;ncărcătura vehiculului atinge 
