...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 9 - partea 5 - Obligațiile conducătorilor auto în caz de defecțiune tehnică</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c9_p6.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>(6)</strong>
                Conducătorii autovehiculelor şi tractoarelor agricole sau forestiere cu masa maximă autorizată mai mare de 3,5 
                tone sunt obligaţi să poarte echipament de protecţie-avertizare fluorescent-reflectorizant atunci c&acirc;nd 
                execută intervenţii la vehiculul care se află pe partea carosabilă a drumului public.
            </p>
            <p>&nbsp;</p>
            <h2>Regulament - Articolul 155</h2>
            <p>
                <strong>(1)</strong>
                &Icirc;n cazul răm&acirc;nerii &icirc;n p&acirc;nă a unui autovehicul, tractor agricol sau forestier ori a 
                remorcii acestuia, conducătorul ansamblului este obligat să &icirc;l scoată imediat &icirc;n afara părții 
                carosabile sau, dacă nu este posibil, să &icirc;l deplaseze l&acirc;ngă bordura ori acostament, așez&acirc;ndu-l 
                paralel cu axa drumului și lu&acirc;nd măsuri pentru remedierea deficiențelor sau, după caz, de remorcare.
                <em>
                    <u>
                        <strong>
            ...
            <p>
                <strong>(2)</strong>
                Pe timpul nopții sau &icirc;n condiții de vizibilitate redusă, autovehiculul, tractorul agricol sau forestier 
                sau remorca acestuia care are deficiențe la sistemul de iluminare sau de semnalizare luminoasă nu poate fi 
                tractat/tractată pe drumurile publice fără a avea &icirc;n funcțiune, &icirc;n partea st&acirc;nga, &icirc;n 
                față, o lumină de &icirc;nt&acirc;lnire și &icirc;n spate, una de poziție.&nbsp;
                <em>
                    <u>
                        <strong>
            ...
            <h2>Regulament - Articolul 156</h2>
            <p>
                <strong>(1)</strong>
                Dacă un autovehicul, tractor agricol sau forestier sau o remorcă a rămas &icirc;n pană pe partea 
                carosabilă a drumului și nu poate fi deplasat/deplasată &icirc;n afara acesteia, conducătorul autovehiculului, 
                tractorului agricol sau forestier este obligat să pună &icirc;n funcțiune luminile de avarie și să instaleze 
            ...
            <p>
                <strong>(2)</strong>
                Triunghiurile reflectorizante se instalează &icirc;n faţă şi &icirc;n spatele vehiculului, pe aceeaşi bandă 
                de circulaţie, la o distanţă de cel puţin 30 m de acesta, astfel &icirc;nc&acirc;t să poată fi observate 
                din timp de către participanţii la trafic care se apropie. &Icirc;n localităţi, atunci c&acirc;nd circulaţia 
                este intensă, triunghiurile reflectorizante pot fi aşezate la o distanţă mai mica sau chiar pe vehicul, 
                astfel &icirc;nc&acirc;t să poată fi observate din timp de ceilalţi conducători de vehicule.
            </p>
            <p>
                <strong>(3)</strong>
                Dacă vehiculul nu este dotat cu lumini de avarie sau acestea sunt defecte, conducătorul poate folosi, 
                pe timpul nopţii ori &icirc;n condiţii de vizibilitate redusă, o lampă portativă cu lumină galbenă 
                intermitentă, care se instalează la partea din spate a vehiculului.
            </p>
            <p>
                <strong>(4)</strong>
                Se interzice folosirea triunghiurilor reflectorizante ori a luminilor de avarie &icirc;n mod nejustificat 
                sau pentru a simula o răm&acirc;nere &icirc;n pană &icirc;n locurile unde oprirea ori staţionarea este interzisă.
            </p>
            <p>
                <strong>(5) </strong>
                &Icirc;n cazul căderii din vehicule, pe partea carosabilă, a &icirc;ncărcăturii sau a unei părţi din aceasta, 
                care constituie un obstacol ce nu poate fi &icirc;nlăturat imediat, conducătorul este obligat să &icirc;l 
                semnalizeze cu unul dintre mijloacele prevăzute la alin. (1)-(3).
            </p>
