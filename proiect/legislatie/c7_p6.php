...
<body>
    <section class="header">
        ...
        <div class="titlu">
            <h1>Capitolul 7 - partea 6 - drumul în rampă și în pantă</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c8_p1.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>b)</strong>
                &icirc;n apropierea v&acirc;rfurilor de rampă, c&acirc;nd vizibilitatea este redusă sub 50 m;<br/>
                <strong>c)</strong>
                &icirc;n curbe și &icirc;n orice alte locuri unde vizibilitatea este redusă sub 50 m;
            </p>
            ...
            <p>
                ...
                <strong>p)</strong>
                &icirc;n locurile unde este interzisă depășirea.
            </p>
            ...
            <p>
                ...
                <strong>e)</strong>
                &icirc;n pante şi &icirc;n rampe;
            </p>
