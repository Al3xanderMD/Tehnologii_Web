...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 7 - partea 2 - trecerea la nivel cu calea ferată fără bariere</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/Xgcp4FF496E">
            </iframe>                                   
        </div>
        <div>
            <a href="c7_p3.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>(1) </strong>
                Trecerea la nivel cu calea ferată curentă fără bariere sau semibariere se semnalizează, după caz, cu 
                indicatoarele Trecere la nivel cu calea ferată simplă, fără bariere sau Trecere la nivel cu calea ferată 
                dublă, fără bariere , &icirc;nsoţite de indicatorul Oprire .
            </p>
            <p>
                <strong>(2)</strong>
                ...
                intermitent-alternative roşii şi stingerea semnalizării de control reprezentate de lumină intermitentă 
                albă şi, acustic, prin emiterea de semnale sonore intermitente.
            </p>
            <h2>Regulament - Articolul 71</h2>
            <p>
                <strong>(1)</strong>
                Semnalizarea de interzicere a circulaţiei rutiere se considera realizata chiar şi numai &icirc;n una 
            ...
            <p>
                <strong>(1)</strong>
                La trecerea la nivel cu calea ferată curentă, conducătorul de vehicul este obligat să circule cu viteza 
                redusă şi să se asigure ca din partea st&acirc;nga sau din partea dreaptă nu se apropie un vehicul feroviar.
            </p>
            ...
            <p>
                ...
                <strong>c)</strong>
                &icirc;nt&acirc;lneşte indicatorul Trecerea la nivel cu calea ferată simplă, fără bariere , Trecerea la nivel 
