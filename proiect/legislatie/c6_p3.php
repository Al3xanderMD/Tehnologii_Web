...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 6 - partea 3 - manevre - oprirea interzisă</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/Q1MGBASxjGc">
            </iframe>                                   
        </div>
        <div>
            <a href="c6_p4.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>a)</strong>
                imobilizarea vehiculului at&acirc;t timp c&acirc;t este necesară pentru &icirc;mbarcarea sau debarcarea 
                unor persoane, dacă prin aceasta manevra nu a fost perturbată circulaţia pe drumul public respectiv;<br/>
                <strong>b)</strong>
                imobilizarea autovehiculului av &acirc;nd o masă totală maximă autorizată de p &acirc;nă la 3,5 tone, 
                at&acirc;t timp c&acirc;t este necesar pentru operaţiunea de distribuire a mărfurilor alimentare la unităţile 
                comerciale.<br/>
            </p>
            ...
            <p>
                ...
                oprirea şi punerea &icirc;n mişcare.
            </p>
            <p>
                <strong>(2)</strong>
                Intenția conducătorilor de autovehicule, tractoare agricole sau forestiere și tramvaie de a schimba 
                direcția de mers, de a ieși dintr-un r&acirc;nd de vehicule staționate ori de a intra &icirc;ntr-un 
                asemenea r&acirc;nd, de a trece pe o altă bandă de circulație sau de a vira spre dreapta ori spre st&acirc;nga 
            ...
            <h2>Regulament - Articolul 142</h2>
            <p>Se interzice oprirea voluntară a vehiculelor:</p>
            <p>
                <strong>a)</strong>
                &icirc;n zona de acţiune a indicatorului Oprirea interzisă;<br/>
                <strong>b) </strong>
                pe trecerile la nivel cu calea ferată curentă şi la o distanţă mai mica de 50 m &icirc;nainte şi după acestea;<br/>
                <strong>c)</strong>
                pe poduri, pe şi sub pasaje denivelate, precum şi pe viaducte;<br/>
                <strong>d)</strong>
                &icirc;n curbe şi &icirc;n alte locuri cu vizibilitate redusă sub 50 m;<br/>
                <strong>e)</strong>
                pe trecerile pentru pietoni ori la mai puţin de 25 m &icirc;nainte şi după acestea;;<br/>
                <strong>f) </strong>
                &icirc;n intersecţii, inclusiv cele cu circulaţie &icirc;n sens giratoriu, precum şi &icirc;n zona de 
                preselecţie unde sunt aplicate marcaje continue, iar &icirc;n lipsa acestora, la o distanţă mai mica de 
                25 m de coltul intersecţiei;<br/>
                <strong>g)</strong>
                &icirc;n staţiile mijloacelor de transport public de persoane, precum şi la mai puţin de 25 m &icirc;nainte 
                şi după acestea;<br/>
                <strong>h)</strong>
                &icirc;n dreptul altui vehicul oprit pe partea carosabilă, dacă prin aceasta se st&acirc;njeneşte circulaţia 
                a două vehicule venind din sensuri opuse, precum şi &icirc;n dreptul marcajului continuu, &icirc;n cazul 
                &icirc;n care conducătorii celorlalte vehicule care circulă &icirc;n acelaşi sens ar fi obligaţi, din 
                această cauza, să treacă peste acest marcaj;<br/>
                <strong>i) </strong>
                &icirc;n locul &icirc;n care se &icirc;mpiedică vizibilitatea asupra unui indicator sau semnal luminos;<br/>
                <strong>j)</strong>
                pe sectoarele de drum unde sunt instalate indicatoarele cu semnificaţiile Drum &icirc;ngustat, 
                Prioritate pentru circulaţia din sens invers sau Prioritate faţă de circulaţia din sens invers ;<br/>
                <strong>k) </strong>
                pe pistele obligatorii pentru pietoni sau pentru pietoni şi biciclete ori pe benzile rezervate unor 
                anumite categorii de vehicule, semnalizate ca atare;<br/>
                <strong>l)</strong>
                pe platforma caii ferate industriale sau de tramvai ori la mai puţin de 50 m de acestea, dacă circulaţia 
                vehiculelor pe sine ar putea fi st&acirc;njenită sau &icirc;mpiedicată;<br/>
                <strong>m)</strong>
                pe partea carosabilă a autostrăzilor, a drumurilor expres şi a celor naţionale europene (E);<br/>
                <strong>n)</strong>
                pe trotuar, cu excepţia situaţiei &icirc;n care administratorul drumului public a executat amenajări 
                care respectă prevederile art. 144 alin. (2) şi (3);<br/>
                <strong>o)</strong>
                pe pistele pentru biciclete;<br/>
                <strong>p)</strong>
                &icirc;n locurile unde este interzisă depăşirea.
            </p>
                ...
                <p>
                    ...
                    <strong>d)</strong>
                    pe pasaje denivelate, pe poduri, sub poduri și &icirc;n tuneluri. Prin excepție, pot fi depășite 
                    &icirc;n aceste locuri vehiculele cu tracțiune animală, motocicletele fără ataș, mopedele, bicicletele 
                    și trotinetele electrice, dacă vizibilitatea asupra drumului este asigurată pe o distanță mai mare de 
                    20 m, iar lățimea drumului este de cel puțin 7 m;
                    <u>
                        <strong>
                    ...
                    <strong>i)</strong>
                    c&acirc;nd pentru efectuarea manevrei se &icirc;ncalcă marcajul continuu, simplu sau dublu, care 
                    desparte sensurile de mers, iar autovehiculul circulă, chiar şi parţial, pe sensul opus, ori se 
                    &icirc;ncalcă marcajul care delimitează spaţiul de interzicere;<br/>
                    <strong>j)</strong>
                    c&acirc;nd din sens opus se apropie un alt vehicul, iar conducătorul acestuia este obligat să 
                    efectueze manevre de evitare a coliziunii;<br/>
                    <strong>k)</strong>
                    pe sectorul de drum unde s-a format o coloana de vehicule &icirc;n aşteptare, dacă prin aceasta se 
