...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 9 - partea 9 - Obligațiile proprietarilor sau deținătorilor de vehicule</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c9_p10.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>OUG - Articolul 39</h2>
            <p>
                <em>
                    <u>
                        <strong>
                            (Articolul 39 a fost modificat &icirc;n lege și actualizat și pe Școala Rutieră la 31-01-2022)
                        </strong>
                    </u>
                </em>
            </p>
            <p>
                <strong>(1)</strong>
                La solicitarea poliției rutiere sau a poliției locale, proprietarul sau deținătorul mandatat al unui vehicul 
                este obligat să comunice acesteia, &icirc;n termenul indicat &icirc;n cuprinsul solicitării, datele de identificare 
                ale persoanei căreia ia &icirc;ncredințat vehiculul pentru a-l conduce pe drumurile publice. Poliția locală poate 
                solicita aceste date de identificare numai &icirc;n legătură cu exercitarea competențelor &icirc;n domeniul 
                circulației pe drumurile publice.
                <u>
                    <em>
                        <strong>
                            (Alineatul (1) a fost modificat și actualizat pe Școala Rutieră la 11-12-2022)
                        </strong>
                    </em>
                </u>
            </p>
            <p>
                <strong>(2)</strong>
                Obligația de a comunica datele de identificare, prevăzută la alin. (1), se consideră &icirc;ndeplinită 
                dacă proprietarul sau deținătorul mandatat al unui vehicul comunică numele, prenumele, codul numeric 
                personal, domiciliul sau reședința, numărul și seria actului de identitate ale persoanei căreia i-a 
                &icirc;ncredințat vehiculul pentru a-l conduce pe drumurile publice ori, &icirc;n cazul cetățenilor 
                străini, al persoanelor fără cetățenie sau al cetățenilor rom &acirc;ni cu domiciliul &icirc;n străinătate, 
                și seria și numărul pașaportului ori ale altui document de trecere a frontierei de stat, data eliberării 
                acestuia și statul emitent.
            </p>
            <h2>Regulament - Articolul 27</h2>
            <p>
                <strong>(1)</strong>
                Proprietarul de autovehicul sau remorcă, cu domiciliul, sediul ori reşedinţă &icirc;n Rom&acirc;nia, este obligat:
            </p>
            <p>
                <strong>a)</strong>
                să declare autorităţii emitente pierderea, furtul sau distrugerea certificatului de &icirc;nmatriculare, 
                &icirc;n cel mult 48 de ore de la constatare;<br/>
                <strong>b)</strong>
                să depună imediat la autoritatea emitenta originalul certificatului de &icirc;nmatriculare, dacă, 
                după obţinerea duplicatului, a reintrat &icirc;n posesia acestuia.
            </p>
            <p>
                <strong>(2)</strong>
                Persoanele juridice deţinătoare de vehicule au, pe l&acirc;ngă cele prevăzute la alin. (1), şi 
                următoarele obligaţii:
            </p>
            <p>
                <strong>a) </strong>
                să verifice starea tehnică a vehiculelor, să facă menţiuni despre aceasta &icirc;n foaia de parcurs 
                sau ordinul de serviciu şi să nu permită ieşirea &icirc;n circulaţie a celor care nu &icirc;ndeplinesc 
                condiţiile tehnice;<br/>
                <strong>b)</strong>
                să elibereze foaie de parcurs sau ordin de serviciu pentru vehiculele care se deplasează &icirc;n cursa;<br/>
                <strong>c)</strong>
                să nu permită conducerea vehiculului de către persoane care nu poseda permis de conducere corespunzător 
                sau atestat profesional;<br/>
                <strong>d)</strong>
                să nu permită conducătorilor de vehicule să plece &icirc;n cursa sub influența băuturilor alcoolice, 
                a substanțelor psihoactive ori &icirc;ntr-o stare accentuată de oboseală;
                <em>
                    <u>
                        <strong>
                            (Punctul d) a fost modificat &icirc;n lege și actualizat și pe Școala Rutieră la 06-10-2021)
                        </strong>
                    </u>
                </em>
                <br/>
                <strong>e)</strong>
                să tina seama de observaţiile făcute de poliţişti sau de conducătorii de vehicule &icirc;n foaia de parcurs;<br/>
                <strong>f)</strong>
                să anunţe imediat politia despre orice accident de circulaţie &icirc;n care sunt implicaţi conducătorii 
                de vehicule proprii care nu poseda documente de constatare a acestuia;<br/>
                <strong>g)</strong>
                să verifice respectarea timpilor de repaus şi de odihna, precum şi a regimului legal de viteză, prin 
                citirea &icirc;nregistrărilor aparatelor de control al timpilor de odihna şi al vitezei de deplasare;<br/>
                <strong>h)</strong>
                să verifice existenţa autorizaţiei speciale de transport şi respectarea condiţiilor &icirc;nscrise 
                &icirc;n aceasta.
            </p>
            <h2>Regulament - Articolul 28</h2>
            <p>
                <strong>(1)</strong>
                Deţinătorii de vehicule pot monta pe acestea sisteme sonore antifurt.
            </p>
            <p>
                <strong>(2)</strong>
                Durata semnalului emis de sistemul prevăzut la alin. (1) nu trebuie să fie mai mare de un minut, iar 
                intensitatea acestuia nu trebuie să depăşească pragul fonic prevăzut &icirc;n reglementările legale 
                &icirc;n vigoare.
            </p>
            <p>
                <strong>(3)</strong>
                Se interzice montarea pe vehicule a sistemelor sonore antifurt care se declanşează la trecerea, 
                &icirc;n imediată apropiere, a altui vehicul.
            </p>
