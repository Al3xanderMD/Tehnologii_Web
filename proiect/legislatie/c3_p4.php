...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 3 - partea 4 - Semnalizarea temporară</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <video width="800" height="500" controls> <source src="https://www.scoalarutiera.ro/upload/videos/legislations/CLR-Capitulul-3-Partea-4/CLR-Capitulul-3-Partea-4.m3u8" type="application/x-mpegURL"></video>                                                             
        </div>
        <div>
            <a href="c3_p5.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>Regulament - Articolul 67</h2>
            <p> 
                Indicatoarele rutiere temporare corespondente indicatoarelor de avertizare, 
                de restricţie sau interzicere ori indicatoarelor de orientare au aceleaşi 
                caracteristici cu cele permanente, cu deosebirea că fondul alb este &icirc;nlocuit 
                cu fondul galben.
            </p>
