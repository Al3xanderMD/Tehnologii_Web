...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 4 - partea 4 - Zona rezidenţială şi pietonală</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c5_p1.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>Regulament - Articolul 158</h2>
            <p>
                <strong>(1)</strong>
                &Icirc;n zona rezidenţială, semnalizată ca atare, pietonii pot folosi toată lăţimea părţii carosabile, 
                iar jocul copiilor este permis.
            </p>
            <p>
                <strong>(2)</strong>
                Conducătorii de vehicule sunt obligaţi să circule cu o viteza de cel mult 20 km/h, să nu staţioneze 
                sau să parcheze vehiculul &icirc;n afara spatiilor anume destinate şi semnalizate ca atare, să nu 
                st&acirc;njenească sau să &icirc;mpiedice circulaţia pietonilor chiar dacă, &icirc;n acest scop, 
                trebuie să oprească.
            </p>
            <h2>Regulament - Articolul 159</h2>
            <p>
                &Icirc;n zona pietonala, semnalizată ca atare, conducătorul de vehicul poate intra numai dacă locuieşte 
                &icirc;n această zona sau prestează servicii publice din poarta &icirc;n poarta şi nu are 
                altă posibilitate de acces. Acesta este obligat să circule cu viteza maxima de 5 km/h, să nu st&acirc;njenească 
                ori să &icirc;mpiedice circulaţia pietonilor şi, dacă este necesar, să oprească pentru a permite circulaţia 
                acestora.
            </p>
