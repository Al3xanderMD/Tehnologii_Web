...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 8 - partea 4 - Starea tehnică a vehiculelor</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c8_p5.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>OUG - Articolul 7</h2>
            <p>
                Orice vehicul care circulă pe drumurile publice trebuie să corespundă normelor tehnice privind siguranţa 
                circulaţiei rutiere, protecţia mediului şi utilizarea conform destinaţiei.
            </p>
            <h2>OUG - Articolul 8</h2>
            <p>
                Pentru a fi conduse pe drumurile publice, fiecare autovehicul, tractor agricol sau forestier şi tramvai
                 trebuie să fie dotat cu trusă medicală de prim ajutor, două triunghiuri reflectorizante şi un stingător 
                 de incendiu, omologate.
            </p>
            <h2>OUG - Articolul 9</h2>
            <p>
                <strong>(1)</strong>
                Pentru a fi &icirc;nmatriculate, &icirc;nregistrate sau admise &icirc;n circulaţie, autovehiculele şi 
                tractoarele agricole sau forestiere, remorcile şi tramvaiele trebuie să fie omologate &icirc;n condiţiile legii.
            </p>
            <p>
                <strong>(3)</strong>
                Documentul care atestă omologarea este cartea de identitate a vehiculului, eliberată &icirc;n condiţiile legii.
            </p>
            <p>
                <strong>(4)</strong>
                Pentru a fi menţinute &icirc;n circulaţie, vehiculele &icirc;nmatriculate sau &icirc;nregistrate, cu 
                excepţia maşinilor autopropulsate cu o viteză maximă constructivă care nu depăşeşte 25 km/h, a autovehiculelor 
                cu şenile, a tramvaielor şi a vehiculelor cu tracţiune animală, se supun inspecţiei tehnice periodice, 
                conform legislaţiei &icirc;n vigoare.
            </p>
            <p>
                <strong>(5) </strong>
                Inspecția tehnică periodică se efectuează &icirc;n stații autorizate sau &icirc;n reprezentanțe 
                R.A.R., conform legislației &icirc;n vigoare.
            </p>
            <h2>OUG - Articolul 10</h2>
            <p>
                <strong>(1) </strong>
                Este interzisă circulația pe drumurile publice a vehiculelor care nu corespund din punct de vedere tehnic, 
                a celor neasigurate obligatoriu de răspundere civilă auto pentru prejudicii produse terților prin accidente 
                de circulație, a celor pentru care a intervenit suspendarea &icirc;nmatriculării, precum și a vehiculelor 
                &icirc;nregistrate al căror termen de valabilitate a inspecției tehnice periodice a expirat ori este anulată.
            </p>
            <p>
                <strong>(2) </strong>
                Constatarea deficiențelor vehiculelor se face de către poliția rutieră, iar verificarea stării tehnice a 
                vehiculelor aflate &icirc;n trafic pe drumurile publice se face de către poliția rutieră, &icirc;mpreună 
                cu instituțiile abilitate de lege.
            </p>
            <h2>Regulament - Articolul 9</h2>
            <p>
                <strong>(1)</strong>
                P&acirc;nă la &icirc;nmatriculare sau &icirc;nregistrare, vehiculele pot circula pe drumurile publice, 
                fără inspecţie tehnică, &icirc;n baza unei autorizaţii provizorii pentru circulaţie, eliberată de autoritatea 
                competentă, dacă &icirc;ndeplinesc normele tehnice privind siguranţa circulaţiei rutiere.
            </p>
            <p>
                <strong>(2)</strong>
                Se inspectează din punct de vedere tehnic, &icirc;nainte de a fi repuse &icirc;n circulație, autovehiculele, 
                tractoarele agricole sau forestiere, tramvaiele ori remorcile cărora le-au fost efectuate reparații &icirc;n 
                urma unor evenimente care au produs avarii grave la mecanismul de direcție, instalația de fr&acirc;nare sau la 
                structura de rezistență a caroseriei ori a sașiului.
                <u>
                    <em>
                        <strong>
            ...
            <h2>Regulament - Articolul 10</h2>
            <p>
                Autovehiculele, tractoarele folosite &icirc;n exploatări agricole şi forestiere şi vehiculele pentru efectuarea 
                de servicii sau lucrări, tramvaiele şi remorcile trebuie să fie dotate, prin construcţie, cu instalaţii de 
                iluminare, semnalizare luminoasă şi avertizare sonoră, omologate, care să corespundă condiţiilor tehnice 
                stabilite de autoritatea competentă.
            </p>
            <h2>Regulament - Articolul 11</h2>
            <p>
                Autovehiculele destinate exclusiv transportului copiilor trebuie să aibă montat pe caroserie, &icirc;n faţă 
                şi &icirc;n spate, indicatorul Copii!
            </p>
            <h2>Regulament - Articolul 12</h2>
            <p>
                Autovehiculele care depăşesc masa şi/sau gabaritul trebuie echipate cu următoarele dispozitive suplimentare 
                de semnalizare:
            </p>
            <p>
                <strong>a)</strong>
                o plăcuţă de identificare fluorescent-reflectorizantă, av&acirc;nd fondul alb şi chenarul rosu, montată la 
                partea din st&acirc;nga faţă;<br/>
                <strong>b)</strong>
                ...
                care trebuie să funcţioneze concomitent cu luminile de poziţie, precum şi un dispozitiv 
                fluorescent-reflectorizant.
            </p>
            <h2>Regulament - Articolul 13</h2>
            <p>
                Se interzice montarea la autovehicul, tractor agricol sau forestier, tramvai ori remorca a luminilor de altă 
                culoare sau intensitate, a altor lumini, dispozitive ori accesorii de avertizare dec&acirc;t cele omologate.
                <u>
                    <em>
                        <strong>
                            (Articolul 13 a fost modificat și actualizat pe www.scoalarutiera.ro la 06-10-2021)
                        </strong>
                    </em>
                </u>
            </p>
