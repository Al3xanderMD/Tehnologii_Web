...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 10 - partea 5 - Infracțiuni - Părăsirea locului accidentului orimodificarea sau ştergerea urmelor acestuia</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c10_p6.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <h2>Codul penal - Articolul 338</h2>
            <p>Părăsirea locului accidentului ori modificarea sau ştergerea urmelor acestuia</p>
            <p>
                <strong>(1)</strong>
                Părăsirea locului accidentului, fără &icirc;ncuviinţarea poliţiei sau a procurorului care efectuează 
                cercetarea locului faptei, de către conducătorul vehiculului sau de către instructorul auto, aflat 
                &icirc;n procesul de instruire, ori de către examinatorul autorităţii competente, aflat &icirc;n 
                timpul desfăşurării probelor practice ale examenului pentru obţinerea permisului de conducere, 
                implicat &icirc;ntr-un accident de circulaţie, se pedepseşte cu &icirc;nchisoarea de la 2 la 7 ani.
            </p>
            <p>
                <strong>(2)</strong>
                Cu aceeaşi pedeapsă se sancţionează şi fapta oricărei persoane de a modifica starea locului sau de a 
                şterge urmele accidentului de circulaţie din care a rezultat uciderea sau vătămarea integrităţii 
                corporale ori a sănătăţii uneia sau mai multor persoane, fără acordul echipei de cercetare la faţa locului.
            </p>
            <p>
                <strong>(3) </strong>
                Nu constituie infracţiune părăsirea locului accidentului c&acirc;nd:
            </p>
            <p>
                <strong>a)</strong>
                &icirc;n urma accidentului s-au produs doar pagube materiale;<br/>
                <strong>b) </strong>
                conducătorul vehiculului, &icirc;n lipsa altor mijloace de transport, transportă el &icirc;nsuşi persoanele 
                rănite la cea mai apropiată unitate sanitară &icirc;n măsură să acorde asistenţă medicală necesară şi la care 
                a declarat datele personale de identitate şi numărul de &icirc;nmatriculare sau &icirc;nregistrare a vehiculului 
                condus, consemnate &icirc;ntr-un registru special, dacă se &icirc;napoiază imediat la locul accidentului;<br/>
                <strong>c)</strong>
                conducătorul autovehiculului cu regim de circulaţie prioritară anunţă de &icirc;ndată poliţia, iar după 
                terminarea misiunii se prezintă la sediul unităţii de poliţie pe a cărei rază de competenţă s-a produs 
                accidentul, &icirc;n vederea &icirc;ntocmirii documentelor de constatare;<br/>
                <strong>d) </strong>
                victima părăseşte locul faptei, iar conducătorul de vehicul anunţă imediat evenimentul la cea mai apropiată 
                unitate de poliţie.
            </p>
