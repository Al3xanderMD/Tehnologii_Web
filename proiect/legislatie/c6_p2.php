...
<body>
    <section class="header">
        ...
        <div class="titlu">
            <h1>Capitolul 6 - partea 2 - manevre - oprirea și staționarea</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/azZ_4Fwjl2s">
            </iframe>                                   
        </div>
        <div>
            <a href="c6_p3.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                ...
                Peste aceasta durată, imobilizarea se consideră staţionare.
            </p>
            <p>
                <strong>(5)</strong>
                Vehiculul oprit sau staţionat pe partea carosabilă trebuie aşezat l&acirc;ngă şi &icirc;n paralel cu marginea 
                acesteia, pe un singur r&acirc;nd, dacă printr-un alt mijloc de semnalizare nu se dispune altfel. Motocicletele 
                fără ataş, mopedele şi bicicletele pot fi oprite sau staţionate şi c&acirc;te două, una l&acirc;ngă alta.<br/>
            </p>
            ...
            <p>
                <strong>(1)</strong>
                Conducătorii autovehiculelor, tractoarelor agricole sau forestiere imobilizate pe drumurile publice, care 
                se &icirc;ndepărtează de acestea, sunt obligați să acționeze fr&acirc;nă de ajutor, să oprească funcționarea 
                motorului și să cupleze &icirc;ntr-o treapta de viteză inferioară sau &icirc;n cea de parcare dacă autovehiculul, 
                tractorul agricol sau forestier are transmisie automată.
                <em>
                    <u>
                        <strong>(Alineatul (1) a fost modificat și actualizat pe www.scoalarutiera.ro la 06-10-2021)</strong>
                    </u>
                </em>
            </p>
            <p>
                <strong>(2)</strong>
                &Icirc;n cazul imobilizării involuntare a autovehiculului, tractorului agricol sau forestier &icirc;n panta 
                sau &icirc;n rampa, pe l&acirc;ngă obligațiile prevăzute la alin. (1) conducătorul trebuie să bracheze rotile 
                directoare.
                <em>
                    <u>
                        <strong>
            ...
            <p>
                <strong>(3)</strong>
                &Icirc;n cazul imobilizării involuntare a autovehiculului, tractorului agricol sau forestier &icirc;n pasaje 
                subterane sau &icirc;n tuneluri, conducătorul acestuia este obligat să oprească funcționarea motorului.
                <em>
                    <u>
                        <strong>
            ...
            <p>
                <strong>(4)</strong>
                &Icirc;n localităţi, pe drumurile cu sens unic, oprirea sau staţionarea voluntară a vehiculelor este permisă 
                şi pe partea st&acirc;nga, dacă răm&acirc;ne liberă cel puţin o bandă de circulaţie.
            </p>
            <p>
                <strong>(5)</strong>
                &Icirc;n afara localităţilor oprirea sau staţionarea voluntară a vehiculelor se face &icirc;n afara părţii 
                carosabile, iar atunci c&acirc;nd nu este posibil, c&acirc;t mai aproape de marginea din dreapta a drumului, 
                paralel cu axa acestuia.
            </p>
            <p>
                <strong>(8)</strong>
                Se consideră staţionare pe partea carosabilă situaţia &icirc;n care oricare dintre roţile vehiculului sau 
                remorcii se regăseşte pe partea carosabilă.
            </p>
            <h2>Regulament - Articolul 145</h2>
            <p>
                Se interzice conducătorului de autovehicul, tractor agricol sau forestier și pasagerilor că &icirc;n timpul 
                opririi sau staționării să deschidă ori să lase deschise ușile acestuia sau să coboare fără să se asigure că 
                nu creează un pericol pentru circulație.
                <em>
                    <u>
                        <strong>
                            (Articolul 145 a fost modificat și actualizat pe www.scoalarutiera.ro la 06-10-2021)
                        </strong>
                    </u>
                </em>
            </p>            
