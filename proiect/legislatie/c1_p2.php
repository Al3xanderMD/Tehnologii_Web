...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 1 - partea 2: Sensul și banda de circulație</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/McREBZkgs8I">
            </iframe>       
        </div>
        <div>
            <a href="c2_p1.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p> 
                <strong>7.</strong>
                banda de circulaţie - subdiviziunea longitudinală a părţii carosabile, 
                materializată prin marcaje rutiere sau alte mijloace, dacă are o lăţime 
                corespunzătoare pentru circulaţia &icirc;ntr-un sens a unui şir de vehicule, 
                altele dec &acirc;t vehiculele care se deplasează pe două roţi;
            </p>

            <p> 
                <strong>8.</strong>
                banda de urgenţă - subdiviziunea longitudinală suplimentară, 
                situată la extremitatea din partea dreapta a autostrăzii, 
                &icirc;n sensul de circulaţie, destinată exclusiv staţionării 
                autovehiculelor &icirc;n cazuri justificate, precum şi circulaţiei 
                autovehiculelor cu regim prioritar care se deplasează la intervenţii 
                sau &icirc;n misiuni cu caracter de urgenţă;
            </p>

            <p> 
                <strong>9.</strong>
                banda reversibilă - banda de circulaţie, marcată şi semnalizată, 
                situată l &acirc;ngă axa drumului, destinată circulaţiei autovehiculelor 
                &icirc;ntr-un sens sau &icirc;n altul, &icirc;n funcţie de intensitatea traficului;
            </p>
              <h2>OUG - Articolul 41</h2>
            <p>
                <strong>(2) </strong>
                Numerotarea benzilor de circulaţie pe fiecare sens se efectuează &icirc;n ordine 
                crescătoare de la marginea din partea dreapta a drumului către axa acestuia. 
                &Icirc;n cazul autostrăzilor, banda de urgenţă nu intră &icirc;n numerotarea 
            ...
            <p> 
                <strong>(3) </strong>
                Se interzice circulaţia, oprirea sau staţionarea autovehiculelor pe banda de urgenţă, 
                cu excepţia cazurilor justificate, precum şi a autovehiculelor cu regim de circulaţie 
                prioritar.
            </p>
            ...
            <p> 
                <strong>(2) </strong>
                Semnalul luminos intermediar care are forma unei sau unor săgeţi de culoare galbenă ori 
                albă cu v &acirc;rful orientat către dreapta sau st &acirc;nga jos anunţă schimbarea 
                semnalului verde, &icirc;n cazul benzilor cu circulaţie reversibilă, ori faptul că banda 
                deasupra căreia se află este pe punctul de a fi &icirc;nchisă circulaţiei conducătorilor
                 cărora li se adresează, aceştia fiind obligaţi să se deplaseze pe banda sau benzile
                  indicate de săgeţi.         
            </p>
                <h2>Regulament - Articolul 104</h2>
            <p>
                Vehiculele care efectuează transport public de persoane se conduc pe banda rezervată 
                acestora, dacă o astfel de bandă există şi este semnalizată ca atare. Pe aceeaşi bandă 
                pot circula şi autovehiculele cu regim de circulaţie prioritară c &acirc;nd se 
                deplasează &icirc;n acţiuni de intervenţii sau &icirc;n misiuni care au caracter de 
                urgenţă.
            </p>
