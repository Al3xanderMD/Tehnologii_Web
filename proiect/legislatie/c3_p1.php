...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 3 - partea 1 - Semnalizarea rutieră și ordinea de prioritate</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/sB2JBy7TPUc">
            </iframe>                                   
        </div>
        <div>
            <a href="c3_p2.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p> 
                <strong>(1)</strong>
                Circulaţia pe drumurile publice se desfăşoară &icirc;n conformitate cu regulile 
                de circulaţie şi cu respectarea semnificaţiei semnalizării rutiere realizate 
                prin mijloacele de semnalizare, semnalele şi indicaţiile poliţistului rutier 
                care dirijează circulaţia, semnalele speciale de avertizare luminoase sau sonore, 
                de semnalizare temporară şi semnalele conducătorilor de vehicule.                        
            </p>
                <h2>OUG - Articolul 30</h2>
            <p> 
                <strong>(1)</strong>
            ...
            <p> 
              <h2>OUG - Articolul 31</h2>
            <p>
                Participanţii la trafic trebuie să respecte regulile de circulaţie, semnalele, 
                indicaţiile şi dispoziţiile poliţistului rutier, precum şi semnificaţia diferitelor 
                tipuri de mijloace de semnalizare rutieră, &icirc;n următoarea ordine 
                de prioritate:               
            </p>
            <p>
                <strong>a)</strong>
            ...
            <p>
                ...
                prevăzute la art. 32 alin. (2) lit. a) şi b);                     
            </p>
            <p>
                <strong>c)</strong>
                semnalizarea temporară și/sau indicatoarele electronice, care modifică regimul 
                normal de desfășurare a circulației;
                <em>
                    <u>
                        <strong>(Litera (c) a fost modificată &icirc;n lege și actualizată și pe 
                            Școala Rutieră la 02-01-2023)</strong>
                    </u>
                </em>           
            </p>
            <p>
