...
<body>
    <section class="header">
        ...
        <div class="titlu">
            <h1>Capitolul 4 - partea 1 - Drumul cu sens unic</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/VrSzI0hiLeM">
            </iframe>                                   
        </div>
        <div>
            <a href="c4_p2.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>(6)</strong>
                Tramvaiul aflat &icirc;n mers poate fi depăşit şi pe partea st&acirc;ngă atunci 
                c&acirc;nd drumul este cu sens unic sau c &acirc;nd &icirc;ntre şina din dreapta 
                şi marginea trotuarului nu există spaţiu suficient.
            </p>
            ...
            <p>
                <strong>b)</strong>
                r&acirc;ndul de l&acirc;ngă axa drumului sau de l&acirc;ngă marcajul de separare 
                a sensurilor, cei care vor să schimbe direcţia de mers spre st&acirc;nga. C&acirc;nd 
                circulaţia se desfăşoară pe drumuri cu sens unic, conducătorii de vehicule care 
                intenţionează să vireze la st&acirc;nga sunt obligaţi să ocupe r&acirc;ndul de 
                l&acirc;ngă bordura sau acostamentul din partea st&acirc;nga;
            </p>
            <h2>Regulament - Articolul 126</h2>
            <p>Se interzice &icirc;ntoarcerea vehiculului:</p>
            <p>
                <strong>d)</strong>
            ...
            <p>
                <strong>(4)</strong>
                &Icirc;n localităţi, pe drumurile cu sens unic, oprirea sau staţionarea voluntară 
                a vehiculelor este permisă şi pe partea st&acirc;nga, dacă răm&acirc;ne liberă cel
                 puţin o bandă de circulaţie.
            </p>           
