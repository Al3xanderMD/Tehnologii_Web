...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 5 - partea 2 - Prioritatea de trecere - acordată prin indicatoare</h1>
        </div>
        <div class="lectie">
        <div class="video">
            <iframe width="800" height="500" src="https://www.youtube.com/embed/msCv1rLIMqU">
            </iframe>                                   
        </div>
        <div>
            <a href="c5_p3.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                <strong>(4)</strong>
                &Icirc;n intersecţiile cu sens giratoriu, semnalizate ca atare, vehiculele care circulă &icirc;n interiorul 
                acestora au prioritate faţă de cele care urmează să pătrundă &icirc;n intersecţie.
            </p>
            <p>&nbsp;</p>
            <h2>Regulament - Articolul 129</h2>
            <p>
                <strong>(1)</strong>
                Vehiculul care circulă pe un drum public pe care este instalat unul dintre indicatoarele av&acirc;nd 
                semnificaţia: Drum cu prioritate, Intersecţie cu un drum fără prioritate sau 
                Prioritate faţă de circulaţia din sens invers are prioritate de trecere.
            </p>             
