...
<body class="container">
        ...
        <div class="titlu">
            <h1>Capitolul 9 - partea 1 - Obligațiile conducătorilor auto la plecarea la traseu</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c9_p2.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>Pentru a fi conduse pe drumurile publice, fiecare autovehicul, tractor agricol sau forestier şi tramvai 
                trebuie să fie dotat cu trusă medicală de prim ajutor, două triunghiuri reflectorizante şi un stingător 
                de incendiu, omologate.</p>
            <h2>OUG - Articolul 35</h2>
            <p>
                <strong>(6)</strong>
                Conducătorii autovehiculelor şi tractoarelor agricole sau forestiere cu masa maximă autorizată mai mare de 
                3,5 tone sunt obligaţi să poarte echipament de protecţie-avertizare fluorescent-reflectorizant atunci 
                c&acirc;nd execută intervenţii la vehiculul care se află pe partea carosabilă a drumului public.
            </p>
            ...
            <p>
                ...
                <em>
                    <strong>
                        <u>
                            (Partea introductivă a Articolului 147 a fost modificată și actualizată pe www.scoalarutiera.ro la 
                            06-10-2021)
                        </u>
                    </strong>
                </em>
            ...
            <p>
                <strong>1.</strong>
                să aibă asupra sa actul de identitate, permisul de conducere, certificatul de &icirc;nmatriculare sau 
                de &icirc;nregistrare și, după caz, atestatul profesional, precum și celelalte documente prevăzute de 
                legislația &icirc;n vigoare;
            </p>
            <p>
                <strong>3. </strong>
                să verifice funcționarea sistemului de lumini și de semnalizare, a instalației de climatizare, să mențină 
                permanent curate parbrizul, luneta și geamurile laterale ale autovehiculului, tractorului agricol sau 
                forestier, precum și plăcuțele cu numărul de &icirc;nmatriculare sau &icirc;nregistrare ale autovehiculului, 
                tractorului agricol sau forestier și remorcii;
                <em>
                    <strong>
                        <u>
                            (Punctul 3 a fost modificat și actualizat pe www.scoalarutiera.ro la 06-10-2021)
                        </u>
                    </strong>
                </em>
            </p>
