...
<body>
    <section class="header">
        ...
        <div class="titlu">
            <h1>Capitolul 7 - partea 5 - drumul în curbă</h1>
        </div>
        <div class="lectie">
        <div class="video">
        ...
        <div>
            <a href="c7_p6.php" class="vezi-buton">Lectia urmatoare</a>
        </div>
        </div>
        <div class="box1">
            <h1>Articole</h1>
            ...
            <p>
                Conducătorul de vehicul este obligat să circule cu o viteza care să nu depăşească 30 km/h 
                &icirc;n localităţi sau 50 km/h &icirc;n afara localităţilor, &icirc;n următoarele situaţii:
            </p>
            <p>
                <strong>b)</strong>
                &icirc;n curbe deosebit de periculoase semnalizate ca atare sau &icirc;n care vizibilitatea este 
                mai mica de 50 m;
            </p>
