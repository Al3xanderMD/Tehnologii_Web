...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Accesul interzis autovehiculelor</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Indicatorul din imagine se amplasează la intrarea pe drumurile publice pe care accesul autovehiculelor (vehiculele cu motor) este interzis.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/autoveh.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_13.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_15.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
