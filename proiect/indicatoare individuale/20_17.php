...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Parcare cu plată</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Se montează împreună cu indicatorul rutier "Parcare" și îl informează pe participantul la trafic, că parcarea respectivă este cu plată, între orele înscrise pe panou.
                 </p>
                 <p>
                    Pe panoul alăturat, conducătorul auto este informat de prețul pe care trebuie să-l plătească pe oră.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit17.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_16.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_18.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
