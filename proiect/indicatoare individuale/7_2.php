...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Drum îngustat pe ambele părți</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Indicatorul se amplasează la 100-200 de metri de locul în care sectorul de drum începe să se îngusteze pe ambele părți cu cel puțin jumătate de metru.
                </p>
                <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare avertizare/avertizare2.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              </div>
           </div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="7_1.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="7_3.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
