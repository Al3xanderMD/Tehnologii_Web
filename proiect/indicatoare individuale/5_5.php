...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Limite generale de viteză</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Se instalează după trecerea frontierei unui stat.
                  </p>
                  <p>
                    Are rolul de a informa conducătorul de vehicul care sunt limitele generale de viteză aplicabile în statul înscris pe indicator.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info5.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_4.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_6.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
