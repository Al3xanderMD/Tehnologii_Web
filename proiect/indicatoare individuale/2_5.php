...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Accesul interzis bicicletelor </strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Indicatorul rutier se întâlnește la intrarea pe drumul public, unde accesul bicicletelor și trotinetelor electrice este interzis.
                </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/bicicleta.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              </div>
           </div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_4.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_6.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
