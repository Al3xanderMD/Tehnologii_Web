...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Marcaje temporare pentru semnalizarea lucrărilor în zona drumului public</strong>
              </div>
             <div class="panel-body">
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare temporare/lucru39.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="8_38.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="9_1.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
