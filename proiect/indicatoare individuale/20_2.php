...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Distanța între indicator și începutul locului periculos</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                   Panoul alaturat, indică distanța de la indicatorul împreună cu care este montat pe drumurile publice, până la începutul locului la care se referă respectivul indicator.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit2.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_1.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_3.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
