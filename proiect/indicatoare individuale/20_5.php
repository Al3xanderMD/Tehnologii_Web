        ...
        <div class="container1">
             ...
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Se instalează sub indicatoarele de informare și specifică intervalul orar, între care se respectă regulile impuse de indicatorul rutier sub care este amplasat panoul din imagine.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit5.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_4.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_6.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
