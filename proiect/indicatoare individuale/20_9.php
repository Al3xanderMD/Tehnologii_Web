...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Începutul și lungimea zonei de acțiune a indicatorului</strong>
              </div>
             ...
             <p>
                Se montează împreună cu unul din indicatoarele rutiere "Oprirea interzisă" sau "Staționarea interzisă".
             </p>
             <p>
                Are rolul de a preciza de unde începe și ce lungime are zona de acțiune a indicatorului rutier sub care este montat.
             </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit9.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_8.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_10.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
