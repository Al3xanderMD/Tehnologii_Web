...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Direcția drumului cu prioritate</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Panoul adițional se instalează la intrarea intr-o intersecție, pe drumul fără prioritate, indicând prin linia neagră îngroșată direcția drumului cu prioritate. Acesta se instalează sub indicatoarele „Oprire” și „Cedează trecerea”.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit27.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_25.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_27.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
