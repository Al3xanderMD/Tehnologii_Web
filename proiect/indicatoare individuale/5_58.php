...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Zonă industrială</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Indicatorul se instalează în apropierea unei zone industriale.
                  </p>
                  <p>
                    Pe indicator poate fi înscrisă și distanța până la această zonă.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info58.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_57.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_59.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
