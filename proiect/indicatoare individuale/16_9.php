...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Semafor special pentru tramvaie</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Este format din 4 lampi, de culoare albă și se adresează numai tramvaielor.
                </p>
                <p>
                    La aprinderea lămpilor de sus (1, 2 și 3), conducătorul tramvaiului trebuie să oprească; la prinderea lămpilor 3 (sus-dreapta) și 4 (jos), tramvaiul poate vira la dreapta; la aprinderea lămpilor 1 (sus-stânga) și 4 (jos), tramvaiul poate vira la stânga; la aprinderea lămpilor 2 (sus-mijloc) și 4 (jos) tramvaiul poate circula pe direcția înainte.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/semafor/semafor9.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="16_8.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="17_1.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
