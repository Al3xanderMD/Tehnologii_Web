...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Post prim-ajutor</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Indicatorul rutier din imaginea alăturată, se întâlnește în apropierea unui post de prim-ajutor.
                  </p>
                  <p>
                    Pe indicator poate fi înscrisă și distanța până la respectivul punct.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info13.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_12.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_14.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
