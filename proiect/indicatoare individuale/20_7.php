...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Trecere la nivel cu cale ferată industrială completând semnificația indicatorului ,,Alte pericole"</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
               ...
               <p>
                Panoul alăturat, se instalează împreună cu indicatorul rutier "Alte pericole" și semnalizează o trecere la nivel cu o cale ferată industrială.
               </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit7.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_6.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_8.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
