...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Marcaj de reducere a vitezei înaintea unor curbe deosebit de periculoase</strong>
              </div>
             <div class="panel-body">
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/marcaje laterale/laterale9.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="10_8.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="10_10.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
