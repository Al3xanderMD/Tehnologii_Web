...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Cântar pentru autovehicule</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Indicatorul rutier alăturat, se întâlnește în apropierea unui loc special amenajat, dotat cu cântar pentru autovehicule
                  </p>
                  <p>
                    Pe indicator poate fi înscrisă și distanța la care se află.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info67.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_66.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_68.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
