...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Presemnalizare trecere de pietoni</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    În zona lui de acțiune se va circula cu atenție pentru a putea reduce viteza și eventual a opri dacă este cazul, la trecerea de pietoni care urmează. Acest indicator este urmat întotdeauna de indicatorul ''Trecere pentru pietoni''.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare avertizare/avertizare22.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              </div>
           </div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="7_21.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="7_23.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
