             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Indicatorul se montează pe sectorul de drum în locurile în care staționarea vehiculelor este interzisă în zilele pare.
                </p>
                <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/stationare-alt2.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_39.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_41.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
