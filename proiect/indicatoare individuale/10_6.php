...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Marcaje la refugii pe partea carosabilă</strong>
              </div>
             <div class="panel-body">
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/marcaje laterale/laterale6.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="10_5.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="10_7.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
