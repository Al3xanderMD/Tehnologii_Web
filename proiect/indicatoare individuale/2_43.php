...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Zonă cu viteză limitată la 30 km/h</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Sfârșitul zonei de acțiune a indicatorului este anunțat de indicatorul ”Sfârsitul zonei cu viteză limitată la 30 km/h”. 
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/zona-limitare.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_42.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_44.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
