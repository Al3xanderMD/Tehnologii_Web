...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Începutul zonei de acțiune a indicatorului</strong>
              </div>
             ...
             <p>
                Acest panou se instalează împreună cu un indicator și delimitează zona de acțiune a indicatorului la care face referire, în acest caz anunță începutul zonei de acțiune.
             </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit10.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_9.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_11.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
