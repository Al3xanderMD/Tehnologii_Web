...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Semafor cu indicarea direcției de deplasare</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                 ...
                 <p>
                    Pe lămpile de culoare roșie sau verde ale semafoarelor pot fi aplicate săgeți de culoare neagră care indică direcţiile de deplasare corespunzătoare acestora.
                 </p>
                 <p>
                    În acest caz, interdicția sau permisiunea de trecere impusă de semnalul luminos este limitată la direcţia sau direcţiile indicate prin aceste săgeţi (doar înainte sau la dreapta). Aceeaşi semnificaţie o au şi sageţile aplicate pe panourile adiţionale ce însoţesc, la partea inferioară, semafoarele.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/semafor/semafor2.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="16_1.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="16_3.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
