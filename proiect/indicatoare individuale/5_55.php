...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Zonă de vânătoare</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Se montează în apropierea unei zone de vânătoare.
                </p>
                <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info55.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_54.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_56.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
