        ...
        <div class="container1">
             ...
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Acest indicator rutier se instalează la începutul zonei destinate pietonilor.
                </p>
                <p>
                    În zona pietonală, semnalizată ca atare, conducătorul de vehicul poate intra numai dacă locuieşte în acea zonă sau prestează servicii publice „din poartă în poartă” şi nu are altă posibilitate de acces.
                </p>
                <p>
                    Pe acest sector de drum, viteza maximă admisă este de 5 km/h.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info44.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_43.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_45.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
