...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Accesul interzis vehiculelor care transportă substanțe explozive sau ușor inflamabile</strong>
              </div>
             <div class="panel-body">
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/exploziv.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_44.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_46.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
