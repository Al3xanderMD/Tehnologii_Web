...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Sfârșitul zonei de acțiune a indicatorului</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Acest panou se instalează împreună cu un indicator și delimitează zona de acțiune a indicatorului la care face referire, în acest caz anunță sfârșitul zonei de acțiune.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit12.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_11.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_13.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
