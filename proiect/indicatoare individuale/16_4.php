...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Semafor cu panou de contrast </strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Semaforul se instalează de regulă, pe partea dreaptă a drumului în sensul de mers, iar acolo unde observarea lui poate fi împiedicată, se amplasează deasupra părții carosabile, central sau în consolă sau pe scuar în partea stângă.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/semafor/semafor4.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="16_3.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="16_5.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
