             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Se amplasează înaintea punctului vamal.
                </p>
                <p>
                    La întâlnirea acestui indicator rutier, conducătorul de vehicul este obligat să oprească la punctul vamal.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/vama.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_31.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_33.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
