...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Monitorizare trafic</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Indicatorul rutier informează că pe următorul sector de drum, traficul este monitorizat.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info75.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_74.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_76.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
