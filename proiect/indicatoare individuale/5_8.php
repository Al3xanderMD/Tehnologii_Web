             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Conducătorul auto va întâlni acest indicator la intrarea pe autostradă.
                  </p>
                  <p>
                    La întâlnirea acestui indicator conducătorii auto sunt obligați să circule cu cel puțin 50 km/h.
                  </p>
                  <p>
                    Pe autostradă sunt interzise manevrele de întoarcere, oprire, staționare, mers înapoi, precum și circulația pe banda de urgență.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info8.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_7.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_9.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
