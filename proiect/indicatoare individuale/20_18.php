...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Exceptarea unor categorii de vehicule de la semnificația indicatorului</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Se instalează împreună cu un indicator de interzicere sau restricție atunci când categoria de autovehicule reprezentate pe indicator este exceptată de la regulile de circulație impuse de indicator.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit18.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_17.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_19.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
