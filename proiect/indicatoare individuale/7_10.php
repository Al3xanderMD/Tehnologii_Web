             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Indicatorul din imagine se amplasează la 100-200 de metri de locul în care sectorul de drum începe să se îngusteze pe partea dreaptă (cu cel puțin jumătate de metru).
                </p>
                <p>
                ...
                <p>
                    În cazul în care banda pe care circulați se îngustează atât de mult încât trebuie să intrați pe o altă bandă de circulație sau pe sensul opus de circulație, trebuie să acordați prioritate celor de pe banda pe care doriți să intrați sau, după caz, celor care circulă pe sensul opus.
                </p>
                <p>
                    În cazul în care banda pe care circulați se sfârșește, trebuie să acordați prioritate celor de pe banda pe care doriți să intrați.
                </p>
                <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare avertizare/avertizare10.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              </div>
           </div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="7_9.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="7_11.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
