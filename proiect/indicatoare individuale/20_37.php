...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Vehicule care transportă substanțe explozive sau ușor inflamabile</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    În acest caz, le este interzis să circule pe sectorul de drum respectiv, vehiculelor care transportă substanțe explozive sau ușor inflamabile.
                  </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit43.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_36.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_38.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
