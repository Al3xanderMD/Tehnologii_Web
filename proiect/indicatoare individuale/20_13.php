...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Categoria de autovehicule la care se referă indicatorul</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Precizează categoria de autovehicule la care face referire indicatorul sub care este amplasat.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit13.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_12.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_14.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
