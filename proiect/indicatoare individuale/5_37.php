             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Are rolul de a-l informa pe conducătorul de vehicul că, în apropiere se află un loc special amenajat pentru parcare.
                  </p>
                  <p>
                    Pe indicatorul rutier este specificat că, parcarea se va face cu două roți pe trotuar.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info37.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_36.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_38.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
