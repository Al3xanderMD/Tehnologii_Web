        ...
        <div class="container1">
             ...
             <div class="panel-body">
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panou36.png" alt="" style="width:70%; vertical-align: middle;">
                <img src="../indicatoare/panouri/panou37.png" alt="" style="width:70%; vertical-align: middle;">
                <img src="../indicatoare/panouri/panou38.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_31.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_33.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
