...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Distanța până la locul la care se referă indicatorul de presemnalizare sau informare</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Panoul alăturat, indică distanța până la locul la care se referă indicatorul rutier de presemnalizare sau informare.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit1.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    ...
                    <div class="column" style="max-width: 50%;">
                        <a href="20_2.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
