...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Stație de taximetre</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Acest indicator rutier se întâlnește în locurile special amenajate pentru staționarea taxiurilor.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info18.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_17.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_19.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
