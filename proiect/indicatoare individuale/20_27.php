             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Panoul adițional se instalează la intrarea într-o intersecție, pe drumul cu prioritate, indicând prin linia neagră îngroșată direcția drumului cu prioritate. Acesta se instalează sub indicatorul „Drum cu prioritate”.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit28.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_26.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_28.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
