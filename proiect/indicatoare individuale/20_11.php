...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Confirmarea zonei de acțiune a indicatorului</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Acest panou se instalează împreună cu un indicator și delimitează zona de acțiune a indicatorului la care face referire, în acest caz confirmă zona de acțiune.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit11.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_10.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_12.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
