...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Semafor pentru pietoni</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Semaforul din imaginea alăturată interzice sau permite accesul pietonilor.
                </p>
                <p>
                    Lentila de sus (cea roșie), interzice accesul pietonilor, iar lentila de jos (cea verde) permite accesul pietonilor.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/semafor/semafor6.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="16_5.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="16_7.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
