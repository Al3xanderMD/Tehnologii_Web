...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Informații rutiere</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Indicatorul rutier are rolul de a informa cu privire la frecvențele radio din zona respectivă.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info69.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_68.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_70.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
