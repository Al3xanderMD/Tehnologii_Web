        ...
        <div class="container1">
             ...
             <div class="panel-body">
              <div class="row1"> 
               ...
               <p>
                Panoul informează despre existența în zona respectivă a unor cabine de duș.
               </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit41.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_34.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_36.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
