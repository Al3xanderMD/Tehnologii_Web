             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Acest indicator rutier se întâlnește la intrarea pe drumurile cu sens unic.
                  </p>
                  <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info6.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_5.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_7.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
