...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Semafor de avertizare</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Semafoarele care emit doar semnale de lumina galbenă intermitentă reprezintă un mijloc suplimentar de avertizare asupra unui loc periculos.
                </p>
                <p>
                    Conducătorii de vehicule care întâlnesc semaforul de avertizare, sunt obligați să reducă viteza.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/semafor/semafor8.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="16_7.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="16_9.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
