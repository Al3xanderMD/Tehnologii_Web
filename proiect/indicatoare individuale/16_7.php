...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Semafor pentru pietoni combinat cu dispozitiv de cronometrare a timpului aferent culorii</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Semaforul interzice sau permite accesul pietonilor.
                </p>
                <p>
                    Este dotat cu un dispozitiv de cronometrare a timpului aferent culorii. Dacă silueta este de culoarea verde, atunci pietonilor li se va permite pătrunderea, dacă silueta este de culoarea roșie, atunci pietonilor li se va interzice pătrunderea.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/semafor/semafor7.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="16_6.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="16_8.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
