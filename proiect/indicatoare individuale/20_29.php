...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Trecerea la nivel cu calea ferată prevazută cu instalație de semnalizare luminoasă automată</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Panoul se întâlnește la trecerea la nivel cu calea ferată prevăzută cu instalație de semnalizare luminoasă automată.
                 </p>
                 <p>
                    Se instalează împreună cu indicatoarele ”Trecere la nivel cu calea ferată cu bariere sau semibariere” sau ”Trecere la nivel cu o cale ferată fără bariere”.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit30.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_28.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_30.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
