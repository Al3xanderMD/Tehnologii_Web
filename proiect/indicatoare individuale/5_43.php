...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Sfârșitul zonei cu viteza recomandată 30 km/h</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Acest indicator are rolul de a preciza sfârșitul zonei în care viteza a fost recomandată la 30 kmh.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info43.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_42.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_44.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
