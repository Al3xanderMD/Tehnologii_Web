             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Acest indicator rutier de informare turistică, se întâlnește pe sectoarele de drum din apropierea unor monumente.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/turism/turism3.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="6_2.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="6_4.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
