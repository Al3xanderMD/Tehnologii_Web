...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Marcaj pentru spaţii înguste</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                  <p>Marcaj pentru spaţii înguste.</p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/marcaje diverse/divers3.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="13_2.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="13_4.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
