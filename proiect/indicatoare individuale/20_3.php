...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Direcția și distanța până la locul la care se referă indicatorul</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Acest panou indică direcția și distanța până la locul la care se referă indicatorul împreună cu care este montat.

                 Aceste informații sunt inscripționate pe un astfel de panou adițional în cazul în care ele nu pot fi înscrise direct pe indicator.
                  </p>
                 <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit3.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_2.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_4.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
