...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Rampă pentru persoane cu handicap locomotor</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Informează că în apropierea panoului respectiv, există o rampă pentru persoanele cu handicap locomotor.
                 </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit31.jpg" alt="" style="width:70%; vertical-align: middle;">
                <img src="../indicatoare/panouri/panouedit32.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_29.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_31.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
