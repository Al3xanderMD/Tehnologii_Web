...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Presemnalizarea sediului poliției autostrăzii</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Se întâlnește pe autostrăzi și presemnalizează un sediu de poliție, aflat la 2000 metri de locul unde este amplasat indicatorul rutier.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info77.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_76.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_78.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
