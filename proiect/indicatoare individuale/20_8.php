...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Lungimea sectorului periculos la care se referă indicatorul</strong>
              </div>
             <div class="panel-body">
              ...
              <p>
                Are rolul de a preciza lungimea sectorului de drum periculos la care se referă indicatorul împreună cu care este montat pe drumurile publice.
              </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit8.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_7.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_9.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
