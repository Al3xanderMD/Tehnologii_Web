             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Indicatorul se instalează în apropierea unui centru viticol.
                  </p>
                  <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info57.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_56.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_58.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
