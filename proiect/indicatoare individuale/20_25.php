...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Autovehiculul se ridică</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Se amplasează sub indicatoarele rutiere de interzicere sau restricție.
                 </p>
                 <p>
                    Îi înștiințează pe conducătorii de vehicule că nerespectarea semnificației indicatorului va duce la ridicarea vehiculelor de instituțiile abilitate.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit25.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_24.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_26.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
