...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Limite maxime de viteză pe autostradă, în funcție de condițiile meteorologice</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    Acest indicator rutier, se întâlnește pe autostrăzi pentru a impune conducătorilor auto să circule cu limite diferite de viteză, în funcție de condițiile meteorologice.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info10.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_9.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_11.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
