        ...
        <div class="container1">
             ...
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Se amplasează în zona de preselecție, înaintea intrării în intersecția în care este obligatoriu virajul în sensul indicat de săgeată (sensul săgeții poate indica, după caz, la stânga) manevra de viraj executându-se după depășirea indicatorului.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de obligare/ladr2.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="3_2.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="3_4.html" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
