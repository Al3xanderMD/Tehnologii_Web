...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Sfârșitul limitării de viteză</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Are rolul de a preciza sfârșitul sectorului de drum pe care era impusă limitarea de viteză.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/sflimitare.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_34.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_36.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
