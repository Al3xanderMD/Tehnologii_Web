...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Polei, gheață, zăpadă</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
               ...
               <p>
                Se instalează de obicei împreună cu indicatorul rutier "Drum alunecos" și avertizează participanții la trafic că în condițiile meteorologice de polei, gheață sau zăpadă drumul devine alunecos.
               </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit40.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_33.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_35.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
