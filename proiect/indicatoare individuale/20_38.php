...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Vehicule care transportă mărfuri periculoase</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <p>
                    În acest caz, le este interzis să circule pe sectorul de drum respectiv, vehiculelor care transportă mărfuri periculoase.
                  </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit44.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_37.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_39.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
