...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Stație de alimentare cu carburanți</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
               ...
               <p>
                Acest indicator rutier se întâlnește în apropierea unei stații de alimentare cu carburanți.
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info23.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_22.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_24.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
