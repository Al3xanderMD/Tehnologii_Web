...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Categoriile de autovehicule care trebuie să respecte semnificația indicatorului</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Se amplasează împreună cu indicatorul rutier "Prioritate pentru circulația din sens invers".
                 </p>
                 <p>
                    Precizează categoriile de autovehicule care vor trebui să acorde prioritate.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit14.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_13.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_15.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
