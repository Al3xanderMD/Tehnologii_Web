             ...
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Are rolul de a informa conducătorul de vehicul că în apropiere se află o parcare acoperită sau subterană.
                 </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info38.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_37.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_39.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
