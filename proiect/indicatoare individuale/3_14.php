...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Sfârșitul vitezei minime obligatorii</strong>
              </div>
             <div class="panel-body">
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de obligare/sfmin.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="3_13.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="3_15.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
