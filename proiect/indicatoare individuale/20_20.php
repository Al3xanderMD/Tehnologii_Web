...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Viteaza recomandată pe un sector de drum cu semafoare sincronizate</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Se întâlnește la începutul sectorului de drum cu semafoare sincronizate.
                 </p>
                 <p>
                    Viteza înscrisă pe indicator, reprezintă viteza pe care va trebui să o mențină conducătorul de vehicule, pentru a prinde culoarea verde la toate semafoarele montate pe sectorul de drum respectiv.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit20.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_19.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_21.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
