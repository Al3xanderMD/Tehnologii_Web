...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Modalități în care se execută parcarea</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Panoul alăturat, informează participanții la trafic de modul în care se va face parcarea pe raza indicatorului rutier "Parcare".
                 </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panou33.png" alt="" style="width:70%; vertical-align: middle;">
                <img src="../indicatoare/panouri/panou34.png" alt="" style="width:70%; vertical-align: middle;">
                <img src="../indicatoare/panouri/panou35.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_30.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_32.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
