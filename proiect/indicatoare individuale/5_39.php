...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Complex de servicii</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Acest indicator se află amplasat în apropierea unui complex ce oferă diverse servicii (restaurant, hotel, telefon, service auto).
                 </p>
                 <p>
                    Pe indicator se inscripționează și distanța până la respectivul complex.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info39.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_38.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_40.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
