...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Mașini și utilaje agricole</strong>
              </div>
             <div class="panel-body">
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare avertizare/avertizare43.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              </div>
           </div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="7_42.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="7_44.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
