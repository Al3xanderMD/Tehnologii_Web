...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Oprirea interzisă</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Indicatorul interzice conducătorului de vehicul să oprească.
                </p>
                <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/oprire.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_37.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_39.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
