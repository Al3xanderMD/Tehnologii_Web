...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Sfârșitul zonei pietonale</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Acest indicator rutier se instalează la sfârșitul zonei destinate pietonilor, anulând restricția vitezei maxime admise de 5 km/h.
                </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info45.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_44.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_46.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
