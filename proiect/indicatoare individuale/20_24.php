...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Cu excepția autovehiculelor autorizate</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Se montează de obicei împreună cu un indicator rutier de interzicere sau restricție.
                 </p>
                 <p>
                    Are rolul de a-i informa pe participanții la trafic, că accesul pe sectorul de drum respectiv este permis doar autovehiculelor autorizate.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit24.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_23.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_25.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
