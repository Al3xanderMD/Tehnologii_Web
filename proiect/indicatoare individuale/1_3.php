...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Drum cu prioritate </strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Drumurile care intersectează drumul cu prioritate (cel pe care vă aflați) vor avea instalate unul dintre indicatoarele "Oprire" sau "Cedează trecerea". 
                </p>
                <p>
                    Când este amplasat înaintea unei intersecții, acest indicator poate fi însoțit și de un panou adițional care va preciza direcția drumului cu prioritate.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de prioritate/prioritate.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="1_2.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="1_4.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
