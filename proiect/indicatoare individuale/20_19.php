...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Intervalale de timp cand este permisă staționarea vehiculelor ce efectuează aprovizionarea</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Se instalează împreună cu un indicatorul rutier "Staționarea interzisă" și indică intervalele de timp în care staționarea este permisă.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/panouri/panouedit19.jpg" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="20_18.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="20_20.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
