...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Staționare alternantă</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                  ...
                  <div class="text">
                <p> 
                    Indicatorul se montează pe sectorul de drum în locurile în care staționarea vehiculelor este interzisă în zilele impare.
                </p>
                <p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de interzicere/stationare-alt.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
           </div>
              </div>
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="2_38.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="2_40.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
