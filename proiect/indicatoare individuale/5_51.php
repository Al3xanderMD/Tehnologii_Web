        ...
        <div class="container1">
             ...
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Acest indicator rutier se întâlnește în apropierea unei gări.
                </p>
              ...
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info51.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_50.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_52.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
