...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Semafor pentru biciclete</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                    Acest semafor se întâlnește de regulă la intersecția unui drum public cu o pistă de biciclete și are două lentile.
                </p>
                <p>
                    Lentila de sus (cea roșie), interzice pătrunderea bicicliștilor în intersecție, iar lentila de jos (cea verde) permite pătrunderea bicicliștilor în intersecție.
                </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/semafor/semafor5.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="16_4.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="16_6.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
