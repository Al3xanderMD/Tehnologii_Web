...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Semafor combinat cu dispozitiv de cronometrare a timpului aferent culorii</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                ...
                <p>
                 ...
                 <p>
                    În cazul semaforizării corelate, în lungul unui traseu pot fi instalate dispozitive de cronometrare a timpului aferent culorii, precum şi dispozitive luminoase care să arate participanţilor la trafic timpii stabiliţi prin programul de semaforizare.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/semafor/semafor3.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="16_2.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="16_4.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
