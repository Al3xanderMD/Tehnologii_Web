...
<html>
    ...
    <div class="meniu">
        ...
        <div class="container1">
              ...
              <strong>Refugiu rezervat depanării</strong>
              </div>
             <div class="panel-body">
              <div class="row1"> 
                <div class="column" style="max-width: 10%;"></div>
                 ...
                 <p>
                    Acest indicator rutier are rolul de a informa conducătorul auto, cu privire la un refugiu rezervat depanării de autovehicule.
                 </p>
                  </div>
              </div>
              <div class="row1">
                ...
                <img src="../indicatoare/indicatoare de informare/info76.png" alt="" style="width:70%; vertical-align: middle;">
              </div>
              <div>
              ...
              <div class="panel-footer">
                <div class="row1">
                    <div class="column" style="max-width: 50%;">
                        <a href="5_75.php" class="btn" style="float: left;">Previous</a>
                    </div>
                    <div class="column" style="max-width: 50%;">
                        <a href="5_77.php" class="btn" style="float: right;">Urmator</a>
                    </div>
                </div>
              </div>
          </div>
